...
public class d1i {
    ...
    public static InterfaceC4583a f28226a;

    /* JADX INFO: renamed from: d1i$a */
    ...
    public static void logStack(String str, int i) {
        ...
        String str2 = C2473f.f17566z;
        for (int i2 = 1; i2 <= iMin; i2++) {
            StackTraceElement stackTraceElement = stackTrace[i2];
            String str3 = ".(" + stackTrace[i2].getFileName() + g1i.f38277c + stackTrace[i2].getLineNumber() + ") " + stackTrace[i2].getMethodName();
            str2 = str2 + C2473f.f17566z;
    ...
    public static void setDebugHandle(InterfaceC4583a interfaceC4583a) {
        f28226a = interfaceC4583a;
    }
    ...
    public static void log(String str) {
        ...
        String str2 = ".(" + stackTraceElement.getFileName() + g1i.f38277c + stackTraceElement.getLineNumber() + c0b.f15434d + pl8.f71328a.substring(Integer.toString(stackTraceElement.getLineNumber()).length()) + strSubstring;
        System.out.println(str2 + C2473f.f17566z + str);
        InterfaceC4583a interfaceC4583a = f28226a;
        if (interfaceC4583a != null) {
            interfaceC4583a.message(str2 + C2473f.f17566z + str);
        }
    }
}
