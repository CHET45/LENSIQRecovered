...
public final class q5b extends cl9 {
    ...
    private final void adjustStorage() {
        if (this.f16891d <= 8 || Long.compareUnsigned(oph.m31533constructorimpl(oph.m31533constructorimpl(this.f16892e) * 32), oph.m31533constructorimpl(oph.m31533constructorimpl(this.f16891d) * 25)) > 0) {
            resizeStorage(coe.nextCapacity(this.f16891d));
        } else {
            resizeStorage(coe.nextCapacity(this.f16891d));
        }
    }
    ...
    private final int findInsertIndex(long j) {
        ...
        while (true) {
            ...
            if ((((~j2) << 6) & j2 & (-9187201950435737472L)) != 0) {
                ...
                if (this.f73282f == 0 && ((this.f16888a[iFindFirstAvailableSlot >> 3] >> ((iFindFirstAvailableSlot & 7) << 3)) & 255) != 254) {
                    adjustStorage();
                    iFindFirstAvailableSlot = findFirstAvailableSlot(i2);
                }
                this.f16892e++;
                int i10 = this.f73282f;
                long[] jArr2 = this.f16888a;
                int i11 = iFindFirstAvailableSlot >> 3;
                long j6 = jArr2[i11];
                int i12 = (iFindFirstAvailableSlot & 7) << 3;
                this.f73282f = i10 - (((j6 >> i12) & 255) == 128 ? 1 : 0);
    ...
    private final void initializeGrowth() {
        this.f73282f = coe.loadedCapacity(getCapacity()) - this.f16892e;
    }
    ...
    private final void initializeStorage(int i) {
        ...
        this.f16889b = new long[iMax];
        this.f16890c = new float[iMax];
    }

    private final void resizeStorage(int i) {
        long[] jArr;
        long[] jArr2;
        long[] jArr3 = this.f16888a;
        long[] jArr4 = this.f16889b;
        float[] fArr = this.f16890c;
        int i2 = this.f16891d;
        initializeStorage(i);
        long[] jArr5 = this.f16889b;
        float[] fArr2 = this.f16890c;
        int i3 = 0;
        while (i3 < i2) {
    ...
    public final float getOrPut(long j, @yfb ny6<Float> ny6Var) {
    ...
    public final void plusAssign(@yfb cl9 cl9Var) {
        md8.checkNotNullParameter(cl9Var, ymh.InterfaceC15729h.f102263c);
        putAll(cl9Var);
    }
    ...
    public final void putAll(@yfb cl9 cl9Var) {
        md8.checkNotNullParameter(cl9Var, ymh.InterfaceC15729h.f102263c);
        long[] jArr = cl9Var.f16889b;
        float[] fArr = cl9Var.f16890c;
        long[] jArr2 = cl9Var.f16888a;
    ...
    public final void removeIf(@yfb gz6<? super Long, ? super Float, Boolean> gz6Var) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (gz6Var.invoke(Long.valueOf(this.f16889b[i4]), Float.valueOf(this.f16890c[i4])).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
    ...
    public final void set(long j, float f) {
        ...
        this.f16889b[iFindInsertIndex] = j;
        this.f16890c[iFindInsertIndex] = f;
    }

    public final int trim() {
        int i = this.f16891d;
        int iNormalizeCapacity = coe.normalizeCapacity(coe.unloadedCapacity(this.f16892e));
        if (iNormalizeCapacity >= i) {
            return 0;
        }
        resizeStorage(iNormalizeCapacity);
        return i - this.f16891d;
    }

    public /* synthetic */ q5b(int i, int i2, jt3 jt3Var) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    public final float put(long j, float f, float f2) {
        ...
        if (iFindInsertIndex < 0) {
            ...
            f2 = this.f16890c[iFindInsertIndex];
        }
        this.f16889b[iFindInsertIndex] = j;
        this.f16890c[iFindInsertIndex] = f;
        return f2;
    ...
    public final boolean remove(long j, float f) {
        int iFindKeyIndex = findKeyIndex(j);
        if (iFindKeyIndex < 0 || this.f16890c[iFindKeyIndex] != f) {
            return false;
        }
        removeValueAt(iFindKeyIndex);
        return true;
