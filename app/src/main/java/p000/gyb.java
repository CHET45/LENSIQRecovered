...
public final class gyb {
    ...
    public static final String f41826a = "defaultGson";

    /* JADX INFO: renamed from: b */
    public static final String f41827b = "delegateGson";

    /* JADX INFO: renamed from: c */
    public static final String f41828c = "logUtilsGson";

    /* JADX INFO: renamed from: d */
    public static final Map<String, Gson> f41829d = new ConcurrentHashMap();
    ...
    /* JADX INFO: renamed from: a */
    public static Gson m12041a() {
        Map<String, Gson> map = f41829d;
