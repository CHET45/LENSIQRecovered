...
public abstract class l68 {
    ...
    public /* synthetic */ l68(jt3 jt3Var) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(l68 l68Var, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        if (obj != null) {
        ...
        return l68Var.joinToString(charSequence, charSequence5, charSequence6, i3, charSequence4);
    }

    public final boolean all(@yfb gz6<? super Integer, ? super Integer, Boolean> gz6Var) {
        md8.checkNotNullParameter(gz6Var, "predicate");
        int[] iArr = this.f56334b;
        int[] iArr2 = this.f56335c;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (!gz6Var.invoke(Integer.valueOf(iArr[i4]), Integer.valueOf(iArr2[i4])).booleanValue()) {
                            return false;
                        }
                    }
                    j >>= 8;
    ...
    */
    public final boolean containsValue(int r15) {
        ...
        L44:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.l68.containsValue(int):boolean");
    }
    ...
    */
    public boolean equals(@p000.gib java.lang.Object r19) {
        /*
            ...
            return r2
        L8:
            boolean r3 = r1 instanceof p000.l68
            r4 = 0
            if (r3 != 0) goto Le
            return r4
        Le:
        ...
        L65:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.l68.equals(java.lang.Object):boolean");
    }
    ...
    public final void forEach(@yfb gz6<? super Integer, ? super Integer, bth> gz6Var) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        gz6Var.invoke(Integer.valueOf(iArr[i4]), Integer.valueOf(iArr2[i4]));
                    }
                    j >>= 8;
                }
                if (i2 != 8) {
    ...
    public final int getOrDefault(int i, int i2) {
        int iFindKeyIndex = findKeyIndex(i);
        return iFindKeyIndex >= 0 ? this.f56335c[iFindKeyIndex] : i2;
    }

    public final int getOrElse(int i, @yfb ny6<Integer> ny6Var) {
        md8.checkNotNullParameter(ny6Var, "defaultValue");
        int iFindKeyIndex = findKeyIndex(i);
        return iFindKeyIndex < 0 ? ny6Var.invoke().intValue() : this.f56335c[iFindKeyIndex];
    }
    ...
    */
    public java.lang.String toString() {
        ...
        L75:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.l68.toString():java.lang.String");
    }

    private l68() {
        this.f56333a = coe.f17275e;
        this.f56334b = q78.getEmptyIntArray();
        this.f56335c = q78.getEmptyIntArray();
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean any(@p000.yfb p000.gz6<? super java.lang.Integer, ? super java.lang.Integer, java.lang.Boolean> r18) {
        /*
            r17 = this;
            r0 = r17
            r1 = r18
        ...
        L63:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.l68.any(gz6):boolean");
    }

    public final int count(@yfb gz6<? super Integer, ? super Integer, Boolean> gz6Var) {
        md8.checkNotNullParameter(gz6Var, "predicate");
        int[] iArr = this.f56334b;
        int[] iArr2 = this.f56335c;
        long[] jArr = this.f56333a;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            if (gz6Var.invoke(Integer.valueOf(iArr[i6]), Integer.valueOf(iArr2[i6])).booleanValue()) {
                                i3++;
                            }
                        }
                        j >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(l68 l68Var, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, gz6 gz6Var, int i2, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i3;
        if (obj == null) {
                    ...
                    if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i10 < i9) {
                            if ((j & 255) < 128) {
                                ...
                                jArr2 = jArr3;
                                sb.append((CharSequence) gz6Var.invoke(numValueOf, Integer.valueOf(i13)));
                                i6++;
                                i3 = 8;
                            } else {
                                jArr2 = jArr3;
    ...
    public final String joinToString(@yfb CharSequence charSequence, @yfb CharSequence charSequence2, @yfb CharSequence charSequence3, int i, @yfb CharSequence charSequence4) {
        ...
        int[] iArr3 = this.f56334b;
        int[] iArr4 = this.f56335c;
        long[] jArr = this.f56333a;
        int length = jArr.length - 2;
        if (length >= 0) {
            int i3 = 0;
  ...
  0x009a: PHI (r12v2 int) = (r12v1 int), (r12v3 int) binds: [B:6:0x004c, B:19:0x0098] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb java.lang.CharSequence r22, @p000.yfb java.lang.CharSequence r23, @p000.yfb java.lang.CharSequence r24, int r25, @p000.yfb java.lang.CharSequence r26, @p000.yfb p000.gz6<? super java.lang.Integer, ? super java.lang.Integer, ? extends java.lang.CharSequence> r27) {
        /*
            r21 = this;
            r0 = r21
            r1 = r22
        ...
        La7:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.l68.joinToString(java.lang.CharSequence, java.lang.CharSequence, java.lang.CharSequence, int, java.lang.CharSequence, gz6):java.lang.String");
    }

    @yfb
    @yn8
    public final String joinToString(@yfb CharSequence charSequence, @yfb CharSequence charSequence2, @yfb CharSequence charSequence3, int i, @yfb gz6<? super Integer, ? super Integer, ? extends CharSequence> gz6Var) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i6 < i5) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append(gz6Var.invoke(Integer.valueOf(i8), Integer.valueOf(i9)));
                            i3++;
                        }
                        j >>= 8;
                        i6++;
  ...
  0x0093: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0044, B:20:0x0091] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb java.lang.CharSequence r21, @p000.yfb java.lang.CharSequence r22, @p000.yfb java.lang.CharSequence r23, @p000.yfb p000.gz6<? super java.lang.Integer, ? super java.lang.Integer, ? extends java.lang.CharSequence> r24) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
        ...
        L9d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.l68.joinToString(java.lang.CharSequence, java.lang.CharSequence, java.lang.CharSequence, gz6):java.lang.String");
    }
  ...
  0x0087: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x003a, B:20:0x0085] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb java.lang.CharSequence r21, @p000.yfb java.lang.CharSequence r22, @p000.yfb p000.gz6<? super java.lang.Integer, ? super java.lang.Integer, ? extends java.lang.CharSequence> r23) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
        ...
        L91:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.l68.joinToString(java.lang.CharSequence, java.lang.CharSequence, gz6):java.lang.String");
    }
  ...
  0x0087: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0038, B:20:0x0085] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb java.lang.CharSequence r22, @p000.yfb p000.gz6<? super java.lang.Integer, ? super java.lang.Integer, ? extends java.lang.CharSequence> r23) {
        /*
            r21 = this;
            r0 = r21
            r1 = r22
        ...
        L91:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.l68.joinToString(java.lang.CharSequence, gz6):java.lang.String");
    }
  ...
  0x007d: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x002e, B:20:0x007b] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb p000.gz6<? super java.lang.Integer, ? super java.lang.Integer, ? extends java.lang.CharSequence> r21) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
        ...
        L85:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.l68.joinToString(gz6):java.lang.String");
    }
}
