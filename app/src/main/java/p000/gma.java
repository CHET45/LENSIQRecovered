...
public final class gma {
    ...
    public static int getDialogHeight(Context context) {
        return !context.getResources().getBoolean(C1315R.bool.is_tablet) ? -1 : -2;
    }
    ...
    public static int getDialogWidth(Context context) {
        ...
        context.getResources().getValue(z ? C1315R.dimen.mr_dialog_fixed_width_minor : C1315R.dimen.mr_dialog_fixed_width_major, typedValue, true);
    ...
    public static int getDialogWidthForDynamicGroup(Context context) {
        if (context.getResources().getBoolean(C1315R.bool.is_tablet)) {
