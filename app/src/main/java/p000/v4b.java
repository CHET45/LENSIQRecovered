...
public final class v4b extends h46 {
    ...
    private final void adjustStorage() {
        if (this.f42309d <= 8 || Long.compareUnsigned(oph.m31533constructorimpl(oph.m31533constructorimpl(this.f42310e) * 32), oph.m31533constructorimpl(oph.m31533constructorimpl(this.f42309d) * 25)) > 0) {
            resizeStorage(coe.nextCapacity(this.f42309d));
        } else {
            resizeStorage(coe.nextCapacity(this.f42309d));
        }
    }
    ...
    private final int findInsertIndex(float f) {
        ...
        while (true) {
            ...
            if ((((~j) << 6) & j & (-9187201950435737472L)) != 0) {
                ...
                if (this.f89918f == 0 && ((this.f42306a[iFindFirstAvailableSlot >> 3] >> ((iFindFirstAvailableSlot & 7) << 3)) & 255) != 254) {
                    adjustStorage();
                    iFindFirstAvailableSlot = findFirstAvailableSlot(i2);
                }
                this.f42310e++;
                int i10 = this.f89918f;
                long[] jArr2 = this.f42306a;
                int i11 = iFindFirstAvailableSlot >> 3;
                long j5 = jArr2[i11];
                int i12 = (iFindFirstAvailableSlot & 7) << 3;
                this.f89918f = i10 - (((j5 >> i12) & 255) == 128 ? 1 : 0);
                jArr2[i11] = (j5 & (~(255 << i12))) | (j2 << i12);
                int i13 = this.f42309d;
    ...
    private final void initializeGrowth() {
        this.f89918f = coe.loadedCapacity(getCapacity()) - this.f42310e;
    }
    ...
    private final void initializeStorage(int i) {
        ...
        this.f42307b = new float[iMax];
        this.f42308c = new float[iMax];
    }
    ...
    private final void resizeStorage(int i) {
        ...
        float[] fArr;
        long[] jArr2 = this.f42306a;
        float[] fArr2 = this.f42307b;
        float[] fArr3 = this.f42308c;
        int i2 = this.f42309d;
        initializeStorage(i);
        float[] fArr4 = this.f42307b;
        float[] fArr5 = this.f42308c;
        int i3 = 0;
        while (i3 < i2) {
    ...
    public final float getOrPut(float f, @yfb ny6<Float> ny6Var) {
    ...
    public final void plusAssign(@yfb h46 h46Var) {
        md8.checkNotNullParameter(h46Var, ymh.InterfaceC15729h.f102263c);
        putAll(h46Var);
    }
    ...
    public final void putAll(@yfb h46 h46Var) {
        md8.checkNotNullParameter(h46Var, ymh.InterfaceC15729h.f102263c);
        float[] fArr = h46Var.f42307b;
        float[] fArr2 = h46Var.f42308c;
        long[] jArr = h46Var.f42306a;
    ...
    public final void removeIf(@yfb gz6<? super Float, ? super Float, Boolean> gz6Var) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (gz6Var.invoke(Float.valueOf(this.f42307b[i4]), Float.valueOf(this.f42308c[i4])).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
    ...
    public final void set(float f, float f2) {
        ...
        this.f42307b[iFindInsertIndex] = f;
        this.f42308c[iFindInsertIndex] = f2;
    }

    public final int trim() {
        int i = this.f42309d;
        int iNormalizeCapacity = coe.normalizeCapacity(coe.unloadedCapacity(this.f42310e));
        if (iNormalizeCapacity >= i) {
            return 0;
        }
        resizeStorage(iNormalizeCapacity);
        return i - this.f42309d;
    }

    public /* synthetic */ v4b(int i, int i2, jt3 jt3Var) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    public final float put(float f, float f2, float f3) {
        ...
        if (iFindInsertIndex < 0) {
            ...
            f3 = this.f42308c[iFindInsertIndex];
        }
        this.f42307b[iFindInsertIndex] = f;
        this.f42308c[iFindInsertIndex] = f2;
        return f3;
    ...
    public final boolean remove(float f, float f2) {
        int iFindKeyIndex = findKeyIndex(f);
        if (iFindKeyIndex < 0 || this.f42308c[iFindKeyIndex] != f2) {
            return false;
        }
        removeValueAt(iFindKeyIndex);
        return true;
