...
public abstract class vjb<K> {
    ...
    public /* synthetic */ vjb(jt3 jt3Var) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(vjb vjbVar, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        if (obj != null) {
        ...
        return vjbVar.joinToString(charSequence, charSequence5, charSequence6, i3, charSequence4);
    }

    public final boolean all(@yfb gz6<? super K, ? super Float, Boolean> gz6Var) {
        md8.checkNotNullParameter(gz6Var, "predicate");
        Object[] objArr = this.f91398b;
        float[] fArr = this.f91399c;
        long[] jArr = this.f91397a;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (!gz6Var.invoke(objArr[i4], Float.valueOf(fArr[i4])).booleanValue()) {
                            return false;
                        }
                    }
                    j >>= 8;
    ...
    */
    public final boolean containsValue(float r15) {
        ...
        L46:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.vjb.containsValue(float):boolean");
    }
    ...
    */
    public boolean equals(@p000.gib java.lang.Object r19) {
        /*
            ...
            return r2
        L8:
            boolean r3 = r1 instanceof p000.vjb
            r4 = 0
            if (r3 != 0) goto Le
            return r4
        Le:
            ...
            return r4
        L1b:
            java.lang.Object[] r3 = r0.f91398b
            float[] r5 = r0.f91399c
            long[] r6 = r0.f91397a
            int r7 = r6.length
            int r7 = r7 + (-2)
        ...
        L68:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.vjb.equals(java.lang.Object):boolean");
    }
    ...
    public final int findKeyIndex(K k) {
        ...
        while (true) {
            ...
            for (long j3 = (~j2) & (j2 - coe.f17281k) & (-9187201950435737472L); j3 != 0; j3 &= j3 - 1) {
                ...
                if (md8.areEqual(this.f91398b[iNumberOfTrailingZeros], k)) {
    ...
    public final void forEach(@yfb gz6<? super K, ? super Float, bth> gz6Var) {
    ...
    public final float get(K k) {
        ...
        if (iFindKeyIndex >= 0) {
            return this.f91399c[iFindKeyIndex];
        }
    ...
    public final float getOrDefault(K k, float f) {
        int iFindKeyIndex = findKeyIndex(k);
        return iFindKeyIndex >= 0 ? this.f91399c[iFindKeyIndex] : f;
    }

    public final float getOrElse(K k, @yfb ny6<Float> ny6Var) {
        md8.checkNotNullParameter(ny6Var, "defaultValue");
        int iFindKeyIndex = findKeyIndex(k);
        return iFindKeyIndex >= 0 ? this.f91399c[iFindKeyIndex] : ny6Var.invoke().floatValue();
    }
    ...
    */
    public java.lang.String toString() {
        ...
        Lb:
            ...
            r1.append(r2)
            java.lang.Object[] r2 = r0.f91398b
            float[] r3 = r0.f91399c
            long[] r4 = r0.f91397a
            int r5 = r4.length
            int r5 = r5 + (-2)
        ...
        L79:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.vjb.toString():java.lang.String");
    }

    private vjb() {
        this.f91397a = coe.f17275e;
        this.f91398b = cv2.f27725c;
        this.f91399c = c56.getEmptyFloatArray();
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean any(@p000.yfb p000.gz6<? super K, ? super java.lang.Float, java.lang.Boolean> r18) {
        /*
            r17 = this;
            r0 = r17
            r1 = r18
        ...
        L5f:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.vjb.any(gz6):boolean");
    }

    public final int count(@yfb gz6<? super K, ? super Float, Boolean> gz6Var) {
        md8.checkNotNullParameter(gz6Var, "predicate");
        Object[] objArr = this.f91398b;
        float[] fArr = this.f91399c;
        long[] jArr = this.f91397a;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            if (gz6Var.invoke(objArr[i6], Float.valueOf(fArr[i6])).booleanValue()) {
                                i3++;
                            }
                        }
                        j >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(vjb vjbVar, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, gz6 gz6Var, int i2, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i3;
        if (obj == null) {
                    ...
                    if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i10 < i9) {
                            if ((j & 255) < 128) {
                                ...
                                jArr2 = jArr3;
                                sb.append((CharSequence) gz6Var.invoke(obj2, Float.valueOf(f)));
                                i6++;
                                i3 = 8;
                            } else {
                                jArr2 = jArr3;
    ...
    @yfb
    @yn8
    public final String joinToString(@yfb CharSequence charSequence, @yfb CharSequence charSequence2, @yfb CharSequence charSequence3, int i, @yfb CharSequence charSequence4, @yfb gz6<? super K, ? super Float, ? extends CharSequence> gz6Var) {
        Object[] objArr;
        Object[] objArr2;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i6 < i5) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append(gz6Var.invoke(obj, Float.valueOf(f)));
                            i3++;
                        } else {
                            objArr2 = objArr3;
                        }
  ...
  0x0090: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0044, B:20:0x008e] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb java.lang.CharSequence r21, @p000.yfb java.lang.CharSequence r22, @p000.yfb java.lang.CharSequence r23, int r24, @p000.yfb p000.gz6<? super K, ? super java.lang.Float, ? extends java.lang.CharSequence> r25) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
        ...
        L9a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.vjb.joinToString(java.lang.CharSequence, java.lang.CharSequence, java.lang.CharSequence, int, gz6):java.lang.String");
    }
  ...
  0x008f: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0044, B:20:0x008d] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb java.lang.CharSequence r21, @p000.yfb java.lang.CharSequence r22, @p000.yfb java.lang.CharSequence r23, @p000.yfb p000.gz6<? super K, ? super java.lang.Float, ? extends java.lang.CharSequence> r24) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
        ...
        L99:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.vjb.joinToString(java.lang.CharSequence, java.lang.CharSequence, java.lang.CharSequence, gz6):java.lang.String");
    }
  ...
  0x0083: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x003a, B:20:0x0081] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb java.lang.CharSequence r21, @p000.yfb java.lang.CharSequence r22, @p000.yfb p000.gz6<? super K, ? super java.lang.Float, ? extends java.lang.CharSequence> r23) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
        ...
        L8d:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.vjb.joinToString(java.lang.CharSequence, java.lang.CharSequence, gz6):java.lang.String");
    }
  ...
  0x0083: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0038, B:20:0x0081] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb java.lang.CharSequence r22, @p000.yfb p000.gz6<? super K, ? super java.lang.Float, ? extends java.lang.CharSequence> r23) {
        /*
            r21 = this;
            r0 = r21
            r1 = r22
            ...
            java.lang.String r4 = ""
            r3.append(r4)
            java.lang.Object[] r5 = r0.f91398b
            float[] r6 = r0.f91399c
            long[] r7 = r0.f91397a
            int r8 = r7.length
            int r8 = r8 + (-2)
        ...
        L8d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.vjb.joinToString(java.lang.CharSequence, gz6):java.lang.String");
    }
  ...
  0x0079: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x002e, B:20:0x0077] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb p000.gz6<? super K, ? super java.lang.Float, ? extends java.lang.CharSequence> r21) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
            ...
            java.lang.String r3 = ""
            r2.append(r3)
            java.lang.Object[] r4 = r0.f91398b
            float[] r5 = r0.f91399c
            long[] r6 = r0.f91397a
            int r7 = r6.length
            int r7 = r7 + (-2)
        ...
        L81:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.vjb.joinToString(gz6):java.lang.String");
    }
}
