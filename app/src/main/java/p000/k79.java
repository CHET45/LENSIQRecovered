...
public class k79 {
    ...
    */
    public static int scanLinkDestination(java.lang.CharSequence r4, int r5) {
        ...
        L2b:
            int r0 = r5 + 1
            boolean r3 = p000.bic.isEscapable(r4, r0)
            if (r3 == 0) goto L10
            r5 = r0
            goto L10
        L35:
        ...
        L39:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.k79.scanLinkDestination(java.lang.CharSequence, int):int");
    }
    ...
    private static int scanLinkDestinationWithBalancedParens(CharSequence charSequence, int i) {
        ...
        while (i3 < charSequence.length()) {
            ...
            if (cCharAt == '\\') {
                int i4 = i3 + 1;
                if (bic.isEscapable(charSequence, i4)) {
                    i3 = i4;
                }
            } else if (cCharAt == '(') {
                i2++;
    ...
    public static int scanLinkLabelContent(CharSequence charSequence, int i) {
        while (i < charSequence.length()) {
            switch (charSequence.charAt(i)) {
                ...
                case '\\':
                    int i2 = i + 1;
                    if (bic.isEscapable(charSequence, i2)) {
                        i = i2;
                    }
                    break;
                case ']':
    ...
    */
    public static int scanLinkTitleContent(java.lang.CharSequence r3, int r4, char r5) {
        ...
        L0:
            ...
            if (r0 != r1) goto L18
            int r1 = r4 + 1
            boolean r2 = p000.bic.isEscapable(r3, r1)
            if (r2 == 0) goto L18
            r4 = r1
            goto L25
        L18:
        ...
        L28:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.k79.scanLinkTitleContent(java.lang.CharSequence, int, char):int");
    }
}
