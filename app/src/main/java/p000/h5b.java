...
public final class h5b extends t68 {
    ...
    private final void adjustStorage() {
        if (this.f83804d <= 8 || Long.compareUnsigned(oph.m31533constructorimpl(oph.m31533constructorimpl(this.f83805e) * 32), oph.m31533constructorimpl(oph.m31533constructorimpl(this.f83804d) * 25)) > 0) {
            resizeStorage(coe.nextCapacity(this.f83804d));
        } else {
            resizeStorage(coe.nextCapacity(this.f83804d));
        }
    }
    ...
    private final int findInsertIndex(int i) {
        ...
        while (true) {
            ...
            if ((((~j) << 6) & j & (-9187201950435737472L)) != 0) {
                ...
                if (this.f42413f == 0 && ((this.f83801a[iFindFirstAvailableSlot >> 3] >> ((iFindFirstAvailableSlot & 7) << 3)) & 255) != 254) {
                    adjustStorage();
                    iFindFirstAvailableSlot = findFirstAvailableSlot(i3);
                }
                this.f83805e++;
                int i11 = this.f42413f;
                long[] jArr2 = this.f83801a;
                int i12 = iFindFirstAvailableSlot >> 3;
                long j5 = jArr2[i12];
                int i13 = (iFindFirstAvailableSlot & 7) << 3;
                this.f42413f = i11 - (((j5 >> i13) & 255) == 128 ? 1 : 0);
                jArr2[i12] = ((~(255 << i13)) & j5) | (j2 << i13);
                int i14 = this.f83804d;
    ...
    private final void initializeGrowth() {
        this.f42413f = coe.loadedCapacity(getCapacity()) - this.f83805e;
    }
    ...
    private final void initializeStorage(int i) {
        ...
        this.f83802b = new int[iMax];
        this.f83803c = new long[iMax];
    }
    ...
    private final void resizeStorage(int i) {
        ...
        int[] iArr;
        long[] jArr2 = this.f83801a;
        int[] iArr2 = this.f83802b;
        long[] jArr3 = this.f83803c;
        int i2 = this.f83804d;
        initializeStorage(i);
        int[] iArr3 = this.f83802b;
        long[] jArr4 = this.f83803c;
        int i3 = 0;
        while (i3 < i2) {
    ...
    public final long getOrPut(int i, @yfb ny6<Long> ny6Var) {
    ...
    public final void plusAssign(@yfb t68 t68Var) {
        md8.checkNotNullParameter(t68Var, ymh.InterfaceC15729h.f102263c);
        putAll(t68Var);
    }
    ...
    public final void putAll(@yfb t68 t68Var) {
        md8.checkNotNullParameter(t68Var, ymh.InterfaceC15729h.f102263c);
        int[] iArr = t68Var.f83802b;
        long[] jArr = t68Var.f83803c;
        long[] jArr2 = t68Var.f83801a;
    ...
    public final void removeIf(@yfb gz6<? super Integer, ? super Long, Boolean> gz6Var) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (gz6Var.invoke(Integer.valueOf(this.f83802b[i4]), Long.valueOf(this.f83803c[i4])).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
    ...
    public final void set(int i, long j) {
        ...
        this.f83802b[iFindInsertIndex] = i;
        this.f83803c[iFindInsertIndex] = j;
    }

    public final int trim() {
        int i = this.f83804d;
        int iNormalizeCapacity = coe.normalizeCapacity(coe.unloadedCapacity(this.f83805e));
        if (iNormalizeCapacity >= i) {
            return 0;
        }
        resizeStorage(iNormalizeCapacity);
        return i - this.f83804d;
    }

    public /* synthetic */ h5b(int i, int i2, jt3 jt3Var) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    public final long put(int i, long j, long j2) {
        ...
        if (iFindInsertIndex < 0) {
            ...
            j2 = this.f83803c[iFindInsertIndex];
        }
        this.f83802b[iFindInsertIndex] = i;
        this.f83803c[iFindInsertIndex] = j;
        return j2;
    ...
    public final boolean remove(int i, long j) {
        int iFindKeyIndex = findKeyIndex(i);
        if (iFindKeyIndex < 0 || this.f83803c[iFindKeyIndex] != j) {
            return false;
        }
        removeValueAt(iFindKeyIndex);
        return true;
