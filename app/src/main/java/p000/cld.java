...
public final class cld {
    ...
    public static final int f16900a = 10;

    /* JADX INFO: renamed from: b */
    public static final double f16901b = 3.0d;

    /* JADX INFO: renamed from: cld$a */
    public static final class C2378a implements Comparable<C2378a> {

        /* JADX INFO: renamed from: a */
        public int f16902a = -1;

        /* JADX INFO: renamed from: b */
        public double f16903b = -1.0d;

        @Override // java.lang.Comparable
        public int compareTo(C2378a c2378a) {
            return Double.valueOf(this.f16903b).compareTo(Double.valueOf(c2378a.f16903b));
        }
    }
    ...
    public static Map<Integer, Integer> quantize(int[] iArr, int[] iArr2, int i) {
        ...
        for (int i10 = 0; i10 < iArr2.length; i10++) {
            dArr2[i10] = r1dVar.fromInt(iArr2[i10]);
            i9++;
        }
        int i11 = iMin - i9;
        if (i11 > 0) {
        ...
        C2378a[][] c2378aArr = new C2378a[iMin][];
        for (int i15 = 0; i15 < iMin; i15++) {
            c2378aArr[i15] = new C2378a[iMin];
            for (int i16 = 0; i16 < iMin; i16++) {
                c2378aArr[i15][i16] = new C2378a();
            }
        }
        ...
        while (true) {
            ...
            while (i18 < iMin) {
                ...
                while (i20 < iMin) {
                    int[] iArr9 = iArr8;
                    double dDistance = r1dVar.distance(dArr2[i18], dArr2[i20]);
                    C2378a c2378a = c2378aArr[i20][i18];
                    c2378a.f16903b = dDistance;
                    c2378a.f16902a = i18;
                    C2378a c2378a2 = c2378aArr[i18][i20];
                    c2378a2.f16903b = dDistance;
                    c2378a2.f16902a = i20;
                    i5 = 1;
                    i20++;
                    iArr8 = iArr9;
                ...
                int[] iArr10 = iArr8;
                int i21 = i17;
                Arrays.sort(c2378aArr[i18]);
                for (int i22 = 0; i22 < iMin; i22 += i5) {
                    iArr7[i18][i22] = c2378aArr[i18][i22].f16902a;
                }
                iArr8 = iArr10;
                i17 = i21;
                i18 = i19;
            ...
            while (i24 < i6) {
                ...
                int i26 = iArr6[i24];
                double dDistance2 = r1dVar.distance(dArr3, dArr2[i26]);
                int[][] iArr12 = iArr7;
                double d = dDistance2;
                int i27 = -1;
                int i28 = 0;
                while (i28 < iMin) {
                    C2378a[][] c2378aArr2 = c2378aArr;
                    int i29 = i6;
                    if (c2378aArr[i26][i28].f16903b < 4.0d * dDistance2) {
                        double dDistance3 = r1dVar.distance(dArr3, dArr2[i28]);
                        if (dDistance3 < d) {
                            d = dDistance3;
                            i27 = i28;
                        }
                    ...
                    i28++;
                    i6 = i29;
                    c2378aArr = c2378aArr2;
                }
                C2378a[][] c2378aArr3 = c2378aArr;
                int i30 = i6;
                ...
                iArr7 = iArr12;
                i6 = i30;
                c2378aArr = c2378aArr3;
            }
            int[][] iArr13 = iArr7;
            C2378a[][] c2378aArr4 = c2378aArr;
            int i31 = i6;
            if (i25 == 0 && i23 != 0) {
                i2 = 0;
                iArr3 = iArr11;
        ...
        for (int i37 = i2; i37 < iMin; i37++) {
            int i38 = iArr3[i37];
            if (i38 != 0) {
                int i39 = r1dVar.toInt(dArr2[i37]);
