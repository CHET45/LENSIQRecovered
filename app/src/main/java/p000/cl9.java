...
public abstract class cl9 {
    ...
    public /* synthetic */ cl9(jt3 jt3Var) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(cl9 cl9Var, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        if (obj != null) {
        ...
        return cl9Var.joinToString(charSequence, charSequence5, charSequence6, i3, charSequence4);
    }

    public final boolean all(@yfb gz6<? super Long, ? super Float, Boolean> gz6Var) {
        md8.checkNotNullParameter(gz6Var, "predicate");
        long[] jArr = this.f16889b;
        float[] fArr = this.f16890c;
        long[] jArr2 = this.f16888a;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (!gz6Var.invoke(Long.valueOf(jArr[i4]), Float.valueOf(fArr[i4])).booleanValue()) {
                            return false;
                        }
                    }
                    j >>= 8;
    ...
    */
    public final boolean containsValue(float r15) {
        ...
        L46:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.cl9.containsValue(float):boolean");
    }
    ...
    */
    public boolean equals(@p000.gib java.lang.Object r19) {
        /*
            ...
            return r2
        L8:
            boolean r3 = r1 instanceof p000.cl9
            r4 = 0
            if (r3 != 0) goto Le
            return r4
        Le:
        ...
        L6c:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.cl9.equals(java.lang.Object):boolean");
    }
    ...
    public final int findKeyIndex(long j) {
        ...
        while (true) {
            ...
            for (long j4 = (~j3) & (j3 - coe.f17281k) & (-9187201950435737472L); j4 != 0; j4 &= j4 - 1) {
                ...
                if (this.f16889b[iNumberOfTrailingZeros] == j) {
    ...
    public final void forEach(@yfb gz6<? super Long, ? super Float, bth> gz6Var) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        gz6Var.invoke(Long.valueOf(jArr[i4]), Float.valueOf(fArr[i4]));
                    }
                    j >>= 8;
                }
                if (i2 != 8) {
    ...
    public final float get(long j) {
        ...
        if (iFindKeyIndex >= 0) {
            return this.f16890c[iFindKeyIndex];
        }
    ...
    public final float getOrDefault(long j, float f) {
        int iFindKeyIndex = findKeyIndex(j);
        return iFindKeyIndex >= 0 ? this.f16890c[iFindKeyIndex] : f;
    }

    public final float getOrElse(long j, @yfb ny6<Float> ny6Var) {
        md8.checkNotNullParameter(ny6Var, "defaultValue");
        int iFindKeyIndex = findKeyIndex(j);
        return iFindKeyIndex < 0 ? ny6Var.invoke().floatValue() : this.f16890c[iFindKeyIndex];
    }
    ...
    private cl9() {
        this.f16888a = coe.f17275e;
        this.f16889b = yl9.getEmptyLongArray();
        this.f16890c = c56.getEmptyFloatArray();
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean any(@p000.yfb p000.gz6<? super java.lang.Long, ? super java.lang.Float, java.lang.Boolean> r18) {
        /*
            r17 = this;
            r0 = r17
            r1 = r18
        ...
        L63:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.cl9.any(gz6):boolean");
    }

    public final int count(@yfb gz6<? super Long, ? super Float, Boolean> gz6Var) {
        md8.checkNotNullParameter(gz6Var, "predicate");
        long[] jArr = this.f16889b;
        float[] fArr = this.f16890c;
        long[] jArr2 = this.f16888a;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            if (gz6Var.invoke(Long.valueOf(jArr[i6]), Float.valueOf(fArr[i6])).booleanValue()) {
                                i3++;
                            }
                        }
                        j >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(cl9 cl9Var, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, gz6 gz6Var, int i2, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i3;
        if (obj == null) {
            ...
            long[] jArr3 = cl9Var.f16889b;
            float[] fArr = cl9Var.f16890c;
            long[] jArr4 = cl9Var.f16888a;
                    ...
                    if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i10 < i9) {
                            if ((j & 255) < 128) {
                                ...
                                jArr2 = jArr4;
                                sb.append((CharSequence) gz6Var.invoke(lValueOf, Float.valueOf(f)));
                                i6++;
                                i3 = 8;
                            } else {
                                jArr2 = jArr4;
    ...
    public final String joinToString(@yfb CharSequence charSequence, @yfb CharSequence charSequence2, @yfb CharSequence charSequence3, int i, @yfb CharSequence charSequence4) {
        ...
        long[] jArr3 = this.f16889b;
        float[] fArr = this.f16890c;
        long[] jArr4 = this.f16888a;
        int length = jArr4.length - 2;
        if (length >= 0) {
            int i4 = 0;
            int i5 = 0;
  ...
  0x009a: PHI (r12v2 int) = (r12v1 int), (r12v3 int) binds: [B:6:0x004c, B:19:0x0098] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb java.lang.CharSequence r22, @p000.yfb java.lang.CharSequence r23, @p000.yfb java.lang.CharSequence r24, int r25, @p000.yfb java.lang.CharSequence r26, @p000.yfb p000.gz6<? super java.lang.Long, ? super java.lang.Float, ? extends java.lang.CharSequence> r27) {
        /*
            r21 = this;
            r0 = r21
            r1 = r22
        ...
        La7:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.cl9.joinToString(java.lang.CharSequence, java.lang.CharSequence, java.lang.CharSequence, int, java.lang.CharSequence, gz6):java.lang.String");
    }

    @yfb
    @yn8
    public final String joinToString(@yfb CharSequence charSequence, @yfb CharSequence charSequence2, @yfb CharSequence charSequence3, int i, @yfb gz6<? super Long, ? super Float, ? extends CharSequence> gz6Var) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i6 < i5) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append(gz6Var.invoke(Long.valueOf(j2), Float.valueOf(f)));
                            i3++;
                        }
                        j >>= 8;
                        i6++;
  ...
  0x0093: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0044, B:20:0x0091] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb java.lang.CharSequence r21, @p000.yfb java.lang.CharSequence r22, @p000.yfb java.lang.CharSequence r23, @p000.yfb p000.gz6<? super java.lang.Long, ? super java.lang.Float, ? extends java.lang.CharSequence> r24) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
        ...
        L9d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.cl9.joinToString(java.lang.CharSequence, java.lang.CharSequence, java.lang.CharSequence, gz6):java.lang.String");
    }
  ...
  0x0087: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x003a, B:20:0x0085] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb java.lang.CharSequence r21, @p000.yfb java.lang.CharSequence r22, @p000.yfb p000.gz6<? super java.lang.Long, ? super java.lang.Float, ? extends java.lang.CharSequence> r23) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
        ...
        L91:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.cl9.joinToString(java.lang.CharSequence, java.lang.CharSequence, gz6):java.lang.String");
    }
  ...
  0x0087: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0038, B:20:0x0085] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb java.lang.CharSequence r22, @p000.yfb p000.gz6<? super java.lang.Long, ? super java.lang.Float, ? extends java.lang.CharSequence> r23) {
        /*
            r21 = this;
            r0 = r21
            r1 = r22
        ...
        L91:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.cl9.joinToString(java.lang.CharSequence, gz6):java.lang.String");
    }
  ...
  0x007d: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x002e, B:20:0x007b] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb p000.gz6<? super java.lang.Long, ? super java.lang.Float, ? extends java.lang.CharSequence> r21) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
        ...
        L85:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.cl9.joinToString(gz6):java.lang.String");
    }
}
