...
public class bu9 extends FilterInputStream {

    /* JADX INFO: renamed from: b */
    public static final int f14795b = Integer.MIN_VALUE;

    /* JADX INFO: renamed from: c */
    public static final int f14796c = -1;

    /* JADX INFO: renamed from: a */
    public int f14797a;

    public bu9(@efb InputStream inputStream) {
        super(inputStream);
        this.f14797a = Integer.MIN_VALUE;
    }
