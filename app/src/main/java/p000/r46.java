...
public abstract class r46 {
    ...
    public /* synthetic */ r46(jt3 jt3Var) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(r46 r46Var, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        if (obj != null) {
        ...
        return r46Var.joinToString(charSequence, charSequence5, charSequence6, i3, charSequence4);
    }

    public final boolean all(@yfb gz6<? super Float, ? super Long, Boolean> gz6Var) {
        md8.checkNotNullParameter(gz6Var, "predicate");
        float[] fArr = this.f77008b;
        long[] jArr = this.f77009c;
        long[] jArr2 = this.f77007a;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (!gz6Var.invoke(Float.valueOf(fArr[i4]), Long.valueOf(jArr[i4])).booleanValue()) {
                            return false;
                        }
                    }
                    j >>= 8;
    ...
    */
    public final boolean containsValue(long r16) {
        ...
        L47:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.r46.containsValue(long):boolean");
    }
    ...
    */
    public boolean equals(@p000.gib java.lang.Object r19) {
        /*
            ...
            return r2
        L8:
            boolean r3 = r1 instanceof p000.r46
            r4 = 0
            if (r3 != 0) goto Le
            return r4
        Le:
        ...
        L67:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.r46.equals(java.lang.Object):boolean");
    }
    ...
    public final int findKeyIndex(float f) {
        ...
        while (true) {
            ...
            for (long j3 = (~j2) & (j2 - coe.f17281k) & (-9187201950435737472L); j3 != 0; j3 &= j3 - 1) {
                ...
                if (this.f77008b[iNumberOfTrailingZeros] == f) {
    ...
    public final void forEach(@yfb gz6<? super Float, ? super Long, bth> gz6Var) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        gz6Var.invoke(Float.valueOf(fArr[i4]), Long.valueOf(jArr[i4]));
                    }
                    j >>= 8;
                }
                if (i2 != 8) {
    ...
    public final long get(float f) {
        ...
        if (iFindKeyIndex >= 0) {
            return this.f77009c[iFindKeyIndex];
        }
    ...
    public final long getOrDefault(float f, long j) {
        int iFindKeyIndex = findKeyIndex(f);
        return iFindKeyIndex >= 0 ? this.f77009c[iFindKeyIndex] : j;
    }

    public final long getOrElse(float f, @yfb ny6<Long> ny6Var) {
        md8.checkNotNullParameter(ny6Var, "defaultValue");
        int iFindKeyIndex = findKeyIndex(f);
        return iFindKeyIndex < 0 ? ny6Var.invoke().longValue() : this.f77009c[iFindKeyIndex];
    }
    ...
    private r46() {
        this.f77007a = coe.f17275e;
        this.f77008b = c56.getEmptyFloatArray();
        this.f77009c = yl9.getEmptyLongArray();
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean any(@p000.yfb p000.gz6<? super java.lang.Float, ? super java.lang.Long, java.lang.Boolean> r18) {
        /*
            r17 = this;
            r0 = r17
            r1 = r18
        ...
        L63:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.r46.any(gz6):boolean");
    }

    public final int count(@yfb gz6<? super Float, ? super Long, Boolean> gz6Var) {
        md8.checkNotNullParameter(gz6Var, "predicate");
        float[] fArr = this.f77008b;
        long[] jArr = this.f77009c;
        long[] jArr2 = this.f77007a;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            if (gz6Var.invoke(Float.valueOf(fArr[i6]), Long.valueOf(jArr[i6])).booleanValue()) {
                                i3++;
                            }
                        }
                        j >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(r46 r46Var, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, gz6 gz6Var, int i2, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i3;
        if (obj == null) {
            ...
            float[] fArr = r46Var.f77008b;
            long[] jArr3 = r46Var.f77009c;
            long[] jArr4 = r46Var.f77007a;
                    ...
                    if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i10 < i9) {
                            if ((j & 255) < 128) {
                                ...
                                jArr2 = jArr4;
                                sb.append((CharSequence) gz6Var.invoke(Float.valueOf(f), Long.valueOf(j2)));
                                i6++;
                                i3 = 8;
                            } else {
                                jArr2 = jArr4;
  ...
  0x009a: PHI (r12v2 int) = (r12v1 int), (r12v3 int) binds: [B:6:0x004c, B:19:0x0098] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb java.lang.CharSequence r22, @p000.yfb java.lang.CharSequence r23, @p000.yfb java.lang.CharSequence r24, int r25, @p000.yfb java.lang.CharSequence r26, @p000.yfb p000.gz6<? super java.lang.Float, ? super java.lang.Long, ? extends java.lang.CharSequence> r27) {
        /*
            r21 = this;
            r0 = r21
            r1 = r22
        ...
        La7:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.r46.joinToString(java.lang.CharSequence, java.lang.CharSequence, java.lang.CharSequence, int, java.lang.CharSequence, gz6):java.lang.String");
    }

    @yfb
    @yn8
    public final String joinToString(@yfb CharSequence charSequence, @yfb CharSequence charSequence2, @yfb CharSequence charSequence3, int i, @yfb gz6<? super Float, ? super Long, ? extends CharSequence> gz6Var) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i6 < i5) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append(gz6Var.invoke(Float.valueOf(f), Long.valueOf(j2)));
                            i3++;
                        }
                        j >>= 8;
                        i6++;
  ...
  0x0093: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0044, B:20:0x0091] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb java.lang.CharSequence r21, @p000.yfb java.lang.CharSequence r22, @p000.yfb java.lang.CharSequence r23, @p000.yfb p000.gz6<? super java.lang.Float, ? super java.lang.Long, ? extends java.lang.CharSequence> r24) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
        ...
        L9d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.r46.joinToString(java.lang.CharSequence, java.lang.CharSequence, java.lang.CharSequence, gz6):java.lang.String");
    }
  ...
  0x0087: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x003a, B:20:0x0085] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb java.lang.CharSequence r21, @p000.yfb java.lang.CharSequence r22, @p000.yfb p000.gz6<? super java.lang.Float, ? super java.lang.Long, ? extends java.lang.CharSequence> r23) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
        ...
        L91:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.r46.joinToString(java.lang.CharSequence, java.lang.CharSequence, gz6):java.lang.String");
    }
  ...
  0x0087: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0038, B:20:0x0085] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb java.lang.CharSequence r22, @p000.yfb p000.gz6<? super java.lang.Float, ? super java.lang.Long, ? extends java.lang.CharSequence> r23) {
        /*
            r21 = this;
            r0 = r21
            r1 = r22
        ...
        L91:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.r46.joinToString(java.lang.CharSequence, gz6):java.lang.String");
    }
  ...
  0x007d: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x002e, B:20:0x007b] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.String joinToString(@p000.yfb p000.gz6<? super java.lang.Float, ? super java.lang.Long, ? extends java.lang.CharSequence> r21) {
        /*
            r20 = this;
            r0 = r20
            r1 = r21
        ...
        L85:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.r46.joinToString(gz6):java.lang.String");
    }
}
