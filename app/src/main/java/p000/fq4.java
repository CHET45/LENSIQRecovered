...
public final class fq4 {
    @yfb
    public static final Bitmap toBitmap(@yfb Drawable drawable, @fkd int i, @fkd int i2, @gib Bitmap.Config config) {
    ...
    @gib
    public static final Bitmap toBitmapOrNull(@yfb Drawable drawable, @fkd int i, @fkd int i2, @gib Bitmap.Config config) {
    ...
    public static final void updateBounds(@yfb Drawable drawable, @fkd int i, @fkd int i2, @fkd int i3, @fkd int i4) {
