...
public final class uzh extends mzh {

    /* JADX INFO: renamed from: uzh$a */
    public static class C13804a extends IllegalArgumentException {
        public C13804a(int i, int i2) {
    ...
    public static String decodeUtf8Array(byte[] bArr, int i, int i2) {
        ...
        while (i < i3) {
            byte b = bArr[i];
            if (!mzh.C9618a.m17683e(b)) {
                break;
            }
            i++;
            mzh.C9618a.m17680b(b, cArr, i4);
            i4++;
        }
        int i5 = i4;
        while (i < i3) {
            int i6 = i + 1;
            byte b2 = bArr[i];
            if (mzh.C9618a.m17683e(b2)) {
                int i7 = i5 + 1;
                mzh.C9618a.m17680b(b2, cArr, i5);
                while (i6 < i3) {
                    byte b3 = bArr[i6];
                    if (!mzh.C9618a.m17683e(b3)) {
                        break;
                    }
                    i6++;
                    mzh.C9618a.m17680b(b3, cArr, i7);
                    i7++;
                }
                i5 = i7;
                i = i6;
            } else if (mzh.C9618a.m17685g(b2)) {
                if (i6 >= i3) {
                    throw new IllegalArgumentException("Invalid UTF-8");
                }
                i += 2;
                mzh.C9618a.m17682d(b2, bArr[i6], cArr, i5);
                i5++;
            } else if (mzh.C9618a.m17684f(b2)) {
                if (i6 >= i3 - 1) {
                    throw new IllegalArgumentException("Invalid UTF-8");
                }
                int i8 = i + 2;
                i += 3;
                mzh.C9618a.m17681c(b2, bArr[i6], bArr[i8], cArr, i5);
                i5++;
            } else {
                if (i6 >= i3 - 2) {
                    throw new IllegalArgumentException("Invalid UTF-8");
                ...
                byte b5 = bArr[i + 2];
                i += 4;
                mzh.C9618a.m17679a(b2, b4, b5, bArr[i9], cArr, i5);
                i5 += 2;
            }
        }
    ...
    public static String decodeUtf8Buffer(ByteBuffer byteBuffer, int i, int i2) {
        ...
        while (i < i3) {
            ...
            if (mzh.C9618a.m17683e(b2)) {
                ...
                i += 2;
                mzh.C9618a.m17682d(b2, byteBuffer.get(i6), cArr, i5);
                i5++;
            } else if (mzh.C9618a.m17684f(b2)) {
                if (i6 >= i3 - 1) {
                    throw new IllegalArgumentException("Invalid UTF-8");
                ...
                int i8 = i + 2;
                i += 3;
                mzh.C9618a.m17681c(b2, byteBuffer.get(i6), byteBuffer.get(i8), cArr, i5);
                i5++;
            } else {
                if (i6 >= i3 - 2) {
                    throw new IllegalArgumentException("Invalid UTF-8");
                ...
                i += 4;
                mzh.C9618a.m17679a(b2, b4, b5, byteBuffer.get(i9), cArr, i5);
                i5 += 2;
            }
        }
        return new String(cArr, 0, i5);
