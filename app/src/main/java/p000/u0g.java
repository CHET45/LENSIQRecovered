...
@Deprecated
public class u0g extends SQLiteOpenHelper implements si3 {

    /* JADX INFO: renamed from: a */
    public static final String f86524a = "exoplayer_internal.db";

    /* JADX INFO: renamed from: b */
    public static final int f86525b = 1;

    /* JADX INFO: renamed from: c */
    public static final String f86526c = "SADatabaseProvider";
            ...
            try {
                ...
                if (!"sqlite_sequence".equals(string2)) {
                    ...
                    try {
                        ...
                        yh9.m25916e("SADatabaseProvider", "Error executing " + str, e);
                    }
                }
            } catch (Throwable th) {
                if (cursorQuery != null) {
