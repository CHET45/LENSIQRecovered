...
public class li3 {
    ...
    public static final int f57663a = 1024;

    /* JADX INFO: renamed from: b */
    public static final int f57664b = 65536;

    /* JADX INFO: renamed from: c */
    public static final String f57665c = "utf-8";

    /* JADX INFO: renamed from: d */
    public static final String f57666d = "gb2312";

    /* JADX INFO: renamed from: e */
    public static final String f57667e = "unicode";

    /* JADX INFO: renamed from: f */
    public static final String f57668f = "gb2312";

    /* JADX INFO: renamed from: g */
    public static DisplayMetrics f57669g;
    ...
    public static boolean compareJsonInt(String str, JSONObject jSONObject, JSONObject jSONObject2) {
        try {
            ...
            xi9.m25212e("invalid jsonobject,compare " + str + " error");
            return false;
        }
    }
    ...
    public static int dip2px(Context context, float f) {
        if (f57669g == null) {
            f57669g = context.getResources().getDisplayMetrics();
        }
        return (int) TypedValue.applyDimension(1, f, f57669g);
    }
    ...
    public static byte[] getUTF8Bom(String str) {
        byte[] bArr = null;
        try {
            byte[] bytes = str.getBytes(f57665c);
    ...
    public static int readInt(byte[] bArr, int i) {
        return ((bArr[i] << 24) & (-16777216)) | (bArr[i + 3] & 255) | ((bArr[i + 2] << 8) & 65280) | ((bArr[i + 1] << 16) & 16711680);
    }
    ...
    public static int sp2px(Context context, float f) {
        ...
        return (int) TypedValue.applyDimension(2, f, f57669g);
    }
    ...
    public static int spModify(Context context, float f) {
        ...
        return (int) ((f * TypedValue.applyDimension(1, 1.0f, f57669g)) / TypedValue.applyDimension(2, 1.0f, f57669g));
    }
