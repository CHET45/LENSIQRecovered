...
@ovh
public final class qg5 implements up0, qdh {

    /* JADX INFO: renamed from: k */
    public static final kx7<Long> f74347k = kx7.m15115of(4300000L, 3200000L, 2400000L, 1700000L, 860000L);

    /* JADX INFO: renamed from: l */
    public static final kx7<Long> f74348l = kx7.m15115of(1500000L, 980000L, 750000L, 520000L, 290000L);

    /* JADX INFO: renamed from: m */
    public static final kx7<Long> f74349m;

    /* JADX INFO: renamed from: n */
    public static final kx7<Long> f74350n;

    /* JADX INFO: renamed from: o */
    public static final kx7<Long> f74351o;

    /* JADX INFO: renamed from: p */
    public static final kx7<Long> f74352p;

    /* JADX INFO: renamed from: q */
    public static final int f74353q = 20;

    /* JADX INFO: renamed from: r */
    public static final float f74354r = 0.5f;

    /* JADX INFO: renamed from: s */
    public static final long f74355s = 1000000;

    /* JADX INFO: renamed from: t */
    public static final int f74356t = 0;

    /* JADX INFO: renamed from: u */
    public static final int f74357u = 1;

    /* JADX INFO: renamed from: v */
    public static final int f74358v = 2;

    /* JADX INFO: renamed from: w */
    public static final int f74359w = 3;

    /* JADX INFO: renamed from: x */
    public static final int f74360x = 4;

    /* JADX INFO: renamed from: y */
    public static final int f74361y = 5;

    /* JADX INFO: renamed from: a */
    @hib
    public final Context f74362a;

    /* JADX INFO: renamed from: b */
    public final ox7<Integer, Long> f74363b;

    /* JADX INFO: renamed from: c */
    public final boolean f74364c;

    /* JADX INFO: renamed from: d */
    @xc7("this")
    public final z0h f74365d;

    /* JADX INFO: renamed from: e */
    @xc7("this")
    public final rp0 f74366e;
    ...
    static {
        ...
        f74349m = kx7.m15115of((long) lValueOf, 1300000L, 1000000L, 860000L, 610000L);
        f74350n = kx7.m15115of(2500000L, 1700000L, 1200000L, 970000L, 680000L);
        f74351o = kx7.m15115of(4700000L, 2800000L, 2100000L, 1700000L, 980000L);
        f74352p = kx7.m15115of(2700000L, (long) lValueOf, 1600000L, 1300000L, 1000000L);
    }
    ...
    private long getInitialBitrateEstimateForNetworkType(int i) {
        Long lValueOf = this.f74363b.get(Integer.valueOf(i));
        if (lValueOf == null) {
            lValueOf = this.f74363b.get(0);
        } else if (lValueOf.longValue() == -9223372036854775807L) {
            lValueOf = Long.valueOf(getInitialBitrateEstimatesForCountry(this.f74371j, i));
        }
        if (lValueOf == null) {
            lValueOf = 1000000L;
        }
    ...
    public static long getInitialBitrateEstimatesForCountry(@hib String str, int i) {
        ...
        if (i != 2) {
            if (i == 3) {
                return f74348l.get(initialBitrateCountryGroupAssignment[1]).longValue();
            }
            if (i == 4) {
                return f74349m.get(initialBitrateCountryGroupAssignment[2]).longValue();
            }
            if (i == 5) {
                return f74350n.get(initialBitrateCountryGroupAssignment[3]).longValue();
            }
            if (i != 7) {
                if (i == 9) {
                    return f74352p.get(initialBitrateCountryGroupAssignment[5]).longValue();
                }
                if (i != 10) {
                    return 1000000L;
                }
                return f74351o.get(initialBitrateCountryGroupAssignment[4]).longValue();
            }
        }
        return f74347k.get(initialBitrateCountryGroupAssignment[0]).longValue();
    }
    ...
    public synchronized void onNetworkTypeChanged(int i) {
        int i2 = this.f74367f;
        if (i2 == 0 || this.f74364c) {
            if (this.f74369h) {
                i = this.f74370i;
            }
            if (i2 != i || this.f74371j == null) {
                this.f74367f = i;
                if (i != 1 && i != 0 && i != 8) {
                    if (this.f74371j == null) {
                        this.f74371j = t0i.getCountryCode(this.f74362a);
                    }
                    long initialBitrateEstimateForNetworkType = getInitialBitrateEstimateForNetworkType(i);
                    this.f74368g = initialBitrateEstimateForNetworkType;
                    this.f74366e.onNetworkTypeChange(initialBitrateEstimateForNetworkType);
                    this.f74365d.reset();
                }
            }
        }
    ...
    @Override // p000.up0
    public synchronized void addEventListener(Handler handler, up0.InterfaceC13636a interfaceC13636a) {
        v80.checkNotNull(handler);
        v80.checkNotNull(interfaceC13636a);
        this.f74366e.addEventListener(handler, interfaceC13636a);
    }

    @Override // p000.up0
    public synchronized long getBitrateEstimate() {
        long bandwidthEstimate;
        bandwidthEstimate = this.f74366e.getBandwidthEstimate();
        if (bandwidthEstimate == Long.MIN_VALUE) {
            bandwidthEstimate = this.f74368g;
        }
    ...
    public synchronized long getTimeToFirstByteEstimateUs() {
        return this.f74365d.getTimeToFirstByteEstimateUs();
    }
    ...
    public synchronized void onBytesTransferred(gh3 gh3Var, xh3 xh3Var, boolean z, int i) {
        if (isTransferAtFullNetworkSpeed(xh3Var, z)) {
            this.f74366e.onBytesTransferred(gh3Var, i);
        }
    }
    ...
    public synchronized void onTransferEnd(gh3 gh3Var, xh3 xh3Var, boolean z) {
        if (isTransferAtFullNetworkSpeed(xh3Var, z)) {
            this.f74366e.onTransferEnd(gh3Var);
        }
    }

    @Override // p000.qdh
    public synchronized void onTransferInitializing(gh3 gh3Var, xh3 xh3Var, boolean z) {
        if (isTransferAtFullNetworkSpeed(xh3Var, z)) {
            this.f74365d.onTransferInitializing(xh3Var);
            this.f74366e.onTransferInitializing(gh3Var);
        }
    }
    ...
    public synchronized void onTransferStart(gh3 gh3Var, xh3 xh3Var, boolean z) {
        if (isTransferAtFullNetworkSpeed(xh3Var, z)) {
            this.f74365d.onTransferStart(xh3Var);
            this.f74366e.onTransferStart(gh3Var);
        }
    }

    @Override // p000.up0
    public synchronized void removeEventListener(up0.InterfaceC13636a interfaceC13636a) {
        this.f74366e.removeEventListener(interfaceC13636a);
    }
    ...
    /* JADX INFO: renamed from: qg5$b */
    public static final class C11475b {

        /* JADX INFO: renamed from: a */
        public final Context f74372a;

        /* JADX INFO: renamed from: b */
        public final Map<Integer, Long> f74373b;

        /* JADX INFO: renamed from: c */
        public z0h f74374c = new rnc(20, 0.5f);

        /* JADX INFO: renamed from: d */
        public rp0 f74375d = new yyf.C15895b().build();

        /* JADX INFO: renamed from: e */
        public boolean f74376e = true;

        public C11475b(Context context) {
            this.f74372a = context.getApplicationContext();
        ...
        public qg5 build() {
            return new qg5(this.f74372a, this.f74373b, this.f74374c, this.f74375d, this.f74376e);
        }

        @op1
        public C11475b setBandwidthEstimator(rp0 rp0Var) {
            this.f74375d = rp0Var;
            return this;
        }

        @op1
        public C11475b setInitialBitrateEstimate(long j) {
            Iterator<Integer> it = this.f74373b.keySet().iterator();
            while (it.hasNext()) {
        ...
        @op1
        public C11475b setResetOnNetworkTypeChange(boolean z) {
            this.f74376e = z;
            return this;
        }

        @op1
        public C11475b setTimeToFirstByteEstimator(z0h z0hVar) {
            this.f74374c = z0hVar;
            return this;
        }

        @op1
        public C11475b setInitialBitrateEstimate(int i, long j) {
            this.f74373b.put(Integer.valueOf(i), Long.valueOf(j));
            return this;
        }

        @op1
        public C11475b setInitialBitrateEstimate(String str) {
            String upperCase = i80.toUpperCase(str);
            for (Integer num : this.f74373b.keySet()) {
                setInitialBitrateEstimate(num.intValue(), qg5.getInitialBitrateEstimatesForCountry(upperCase, num.intValue()));
            }
            return this;
        }
    }

    private qg5(Context context, Map<Integer, Long> map, z0h z0hVar, rp0 rp0Var, boolean z) {
        this.f74362a = context == null ? null : context.getApplicationContext();
        this.f74363b = ox7.copyOf((Map) map);
        this.f74365d = z0hVar;
        this.f74366e = rp0Var;
        this.f74364c = z;
        zbb zbbVar = zbb.getInstance(context);
        int networkType = zbbVar.getNetworkType();
        this.f74367f = networkType;
        this.f74368g = getInitialBitrateEstimateForNetworkType(networkType);
        zbbVar.register(new zbb.InterfaceC16078c() { // from class: pg5
            @Override // p000.zbb.InterfaceC16078c
            public final void onNetworkTypeChanged(int i) {
                this.f70686a.onNetworkTypeChanged(i);
            }
        }, bo0.get());
    }
}
