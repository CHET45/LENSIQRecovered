...
@c5e(29)
public final class fw4 implements hw4 {
    @Override // p000.hw4
    @ih4
    public void setUp(@yfb yig yigVar, @yfb yig yigVar2, @yfb Window window, @yfb View view, boolean z, boolean z2) {
        ...
        window.setStatusBarColor(yigVar.getScrimWithEnforcedContrast$activity_release(z));
        window.setNavigationBarColor(yigVar2.getScrimWithEnforcedContrast$activity_release(z2));
        window.setStatusBarContrastEnforced(false);
        window.setNavigationBarContrastEnforced(yigVar2.getNightMode$activity_release() == 0);
        xni xniVar = new xni(window, view);
        xniVar.setAppearanceLightStatusBars(!z);
        xniVar.setAppearanceLightNavigationBars(true ^ z2);
    }
}
