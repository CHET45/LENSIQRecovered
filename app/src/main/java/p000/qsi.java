...
public interface qsi {
    ...
    /* JADX INFO: renamed from: qsi$a */
    public enum EnumC11672a {
        ASCENDING,
        DESCENDING
    }

    EnumC11672a fieldOrder();
    ...
    void writeBytes(int fieldNumber, wj1 value) throws IOException;

    void writeBytesList(int fieldNumber, List<wj1> value) throws IOException;
    ...
    @Deprecated
    void writeGroup(int fieldNumber, Object value, upe schema) throws IOException;

    @Deprecated
    void writeGroupList(int fieldNumber, List<?> value) throws IOException;

    @Deprecated
    void writeGroupList(int fieldNumber, List<?> value, upe schema) throws IOException;
    ...
    <K, V> void writeMap(int fieldNumber, ns9.C10042b<K, V> metadata, Map<K, V> map) throws IOException;

    void writeMessage(int fieldNumber, Object value) throws IOException;

    void writeMessage(int fieldNumber, Object value, upe schema) throws IOException;

    void writeMessageList(int fieldNumber, List<?> value) throws IOException;

    void writeMessageList(int fieldNumber, List<?> value, upe schema) throws IOException;
