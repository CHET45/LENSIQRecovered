...
public enum k67 {
    ...
    k67(int i, @efb String str) {
        this.f52678b = i;
        this.f52677a = str;
    }

    /* JADX INFO: renamed from: a */
    public static k67 m14531a(int i) {
        for (k67 k67Var : values()) {
            if (k67Var.f52678b == i) {
                return k67Var;
            }
        }
    ...
    /* JADX INFO: renamed from: b */
    public String m14532b() {
        return String.format(Locale.ENGLISH, "GifError %d: %s", Integer.valueOf(this.f52678b), this.f52677a);
    }
