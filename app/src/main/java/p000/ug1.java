...
public final class ug1 {
    @yfb
    public static final Bundle bundleOf(@yfb scc<String, ? extends Object>... sccVarArr) {
        Bundle bundle = new Bundle(sccVarArr.length);
        for (scc<String, ? extends Object> sccVar : sccVarArr) {
            ...
            if (objComponent2 == null) {
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    md8.checkNotNull(objComponent2, "null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                    bundle.putParcelableArray(strComponent1, (Parcelable[]) objComponent2);
                } else if (String.class.isAssignableFrom(componentType)) {
                    md8.checkNotNull(objComponent2, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                    bundle.putStringArray(strComponent1, (String[]) objComponent2);
                } else if (CharSequence.class.isAssignableFrom(componentType)) {
                    md8.checkNotNull(objComponent2, "null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");
                ...
                lg1.putSize(bundle, strComponent1, (Size) objComponent2);
            } else {
                ...
                lg1.putSizeF(bundle, strComponent1, (SizeF) objComponent2);
            }
        }
        return bundle;
    }
