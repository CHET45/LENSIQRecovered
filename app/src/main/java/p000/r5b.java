...
public final class r5b extends el9 {
    ...
    private final void adjustStorage() {
        if (this.f33344d <= 8 || Long.compareUnsigned(oph.m31533constructorimpl(oph.m31533constructorimpl(this.f33345e) * 32), oph.m31533constructorimpl(oph.m31533constructorimpl(this.f33344d) * 25)) > 0) {
            resizeStorage(coe.nextCapacity(this.f33344d));
        } else {
            resizeStorage(coe.nextCapacity(this.f33344d));
        }
    }
    ...
    private final int findInsertIndex(long j) {
        ...
        while (true) {
            ...
            if ((((~j2) << 6) & j2 & (-9187201950435737472L)) != 0) {
                ...
                if (this.f77095f == 0 && ((this.f33341a[iFindFirstAvailableSlot >> 3] >> ((iFindFirstAvailableSlot & 7) << 3)) & 255) != 254) {
                    adjustStorage();
                    iFindFirstAvailableSlot = findFirstAvailableSlot(i2);
                }
                this.f33345e++;
                int i10 = this.f77095f;
                long[] jArr2 = this.f33341a;
                int i11 = iFindFirstAvailableSlot >> 3;
                long j6 = jArr2[i11];
                int i12 = (iFindFirstAvailableSlot & 7) << 3;
                this.f77095f = i10 - (((j6 >> i12) & 255) == 128 ? 1 : 0);
                jArr2[i11] = (j6 & (~(255 << i12))) | (j3 << i12);
                int i13 = this.f33344d;
    ...
    private final void initializeGrowth() {
        this.f77095f = coe.loadedCapacity(getCapacity()) - this.f33345e;
    }
    ...
    private final void initializeStorage(int i) {
        ...
        this.f33342b = new long[iMax];
        this.f33343c = new int[iMax];
    }

    private final void resizeStorage(int i) {
        long[] jArr;
        long[] jArr2;
        long[] jArr3 = this.f33341a;
        long[] jArr4 = this.f33342b;
        int[] iArr = this.f33343c;
        int i2 = this.f33344d;
        initializeStorage(i);
        long[] jArr5 = this.f33342b;
        int[] iArr2 = this.f33343c;
        int i3 = 0;
        while (i3 < i2) {
    ...
    public final int getOrPut(long j, @yfb ny6<Integer> ny6Var) {
    ...
    public final void plusAssign(@yfb el9 el9Var) {
        md8.checkNotNullParameter(el9Var, ymh.InterfaceC15729h.f102263c);
        putAll(el9Var);
    }
    ...
    public final void putAll(@yfb el9 el9Var) {
        md8.checkNotNullParameter(el9Var, ymh.InterfaceC15729h.f102263c);
        long[] jArr = el9Var.f33342b;
        int[] iArr = el9Var.f33343c;
        long[] jArr2 = el9Var.f33341a;
    ...
    public final void removeIf(@yfb gz6<? super Long, ? super Integer, Boolean> gz6Var) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (gz6Var.invoke(Long.valueOf(this.f33342b[i4]), Integer.valueOf(this.f33343c[i4])).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
    ...
    public final void set(long j, int i) {
        ...
        this.f33342b[iFindInsertIndex] = j;
        this.f33343c[iFindInsertIndex] = i;
    }

    public final int trim() {
        int i = this.f33344d;
        int iNormalizeCapacity = coe.normalizeCapacity(coe.unloadedCapacity(this.f33345e));
        if (iNormalizeCapacity >= i) {
            return 0;
        }
        resizeStorage(iNormalizeCapacity);
        return i - this.f33344d;
    }

    public /* synthetic */ r5b(int i, int i2, jt3 jt3Var) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    public final int put(long j, int i, int i2) {
        ...
        if (iFindInsertIndex < 0) {
            ...
            i2 = this.f33343c[iFindInsertIndex];
        }
        this.f33342b[iFindInsertIndex] = j;
        this.f33343c[iFindInsertIndex] = i;
        return i2;
    ...
    public final boolean remove(long j, int i) {
        int iFindKeyIndex = findKeyIndex(j);
        if (iFindKeyIndex < 0 || this.f33343c[iFindKeyIndex] != i) {
            return false;
        }
        removeValueAt(iFindKeyIndex);
        return true;
