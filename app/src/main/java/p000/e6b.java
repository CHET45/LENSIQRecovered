...
public final class e6b<K> extends zjb<K> {
    ...
    private final void adjustStorage() {
        if (this.f105301d <= 8 || Long.compareUnsigned(oph.m31533constructorimpl(oph.m31533constructorimpl(this.f105302e) * 32), oph.m31533constructorimpl(oph.m31533constructorimpl(this.f105301d) * 25)) > 0) {
            resizeStorage(coe.nextCapacity(this.f105301d));
        } else {
            resizeStorage(coe.nextCapacity(this.f105301d));
        }
    }
    ...
    private final int findIndex(K k) {
        ...
        while (true) {
            ...
            if ((((~j) << 6) & j & (-9187201950435737472L)) != 0) {
                ...
                if (this.f31906f == 0 && ((this.f105298a[iFindFirstAvailableSlot >> 3] >> ((iFindFirstAvailableSlot & 7) << 3)) & 255) != 254) {
                    adjustStorage();
                    iFindFirstAvailableSlot = findFirstAvailableSlot(i2);
                }
                this.f105302e++;
                int i10 = this.f31906f;
                long[] jArr2 = this.f105298a;
                int i11 = iFindFirstAvailableSlot >> 3;
                long j5 = jArr2[i11];
                int i12 = (iFindFirstAvailableSlot & 7) << 3;
                this.f31906f = i10 - (((j5 >> i12) & 255) == 128 ? 1 : 0);
                jArr2[i11] = (j5 & (~(255 << i12))) | (j2 << i12);
                int i13 = this.f105301d;
    ...
    private final void initializeGrowth() {
        this.f31906f = coe.loadedCapacity(getCapacity()) - this.f105302e;
    }
    ...
    private final void initializeStorage(int i) {
        ...
        this.f105299b = new Object[iMax];
        this.f105300c = new int[iMax];
    }
    ...
    private final void resizeStorage(int i) {
        ...
        int i3 = this.f105301d;
        initializeStorage(i);
        Object[] objArr2 = this.f105299b;
        int[] iArr2 = this.f105300c;
        int i4 = 0;
        while (i4 < i3) {
    ...
    public final void clear() {
        ...
        u70.fill(this.f105299b, (Object) null, 0, this.f105301d);
        initializeGrowth();
    }

    public final int getOrPut(K k, @yfb ny6<Integer> ny6Var) {
    ...
    public final void plusAssign(@yfb zjb<K> zjbVar) {
        md8.checkNotNullParameter(zjbVar, ymh.InterfaceC15729h.f102263c);
        putAll(zjbVar);
    }
    ...
    public final void putAll(@yfb zjb<K> zjbVar) {
        md8.checkNotNullParameter(zjbVar, ymh.InterfaceC15729h.f102263c);
        Object[] objArr = zjbVar.f105299b;
        int[] iArr = zjbVar.f105300c;
        long[] jArr = zjbVar.f105298a;
    ...
    public final void removeIf(@yfb gz6<? super K, ? super Integer, Boolean> gz6Var) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (gz6Var.invoke(this.f105299b[i4], Integer.valueOf(this.f105300c[i4])).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
    ...
    public final void set(K k, int i) {
        ...
        this.f105299b[iFindIndex] = k;
        this.f105300c[iFindIndex] = i;
    }

    public final int trim() {
        int i = this.f105301d;
        int iNormalizeCapacity = coe.normalizeCapacity(coe.unloadedCapacity(this.f105302e));
        if (iNormalizeCapacity >= i) {
            return 0;
        }
        resizeStorage(iNormalizeCapacity);
        return i - this.f105301d;
    }

    public /* synthetic */ e6b(int i, int i2, jt3 jt3Var) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    public final boolean remove(K k, int i) {
        int iFindKeyIndex = findKeyIndex(k);
        if (iFindKeyIndex < 0 || this.f105300c[iFindKeyIndex] != i) {
            return false;
        }
        removeValueAt(iFindKeyIndex);
        return true;
