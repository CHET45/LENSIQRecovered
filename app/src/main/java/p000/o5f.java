...
public class o5f {
    ...
    public static String m18358a(String str, String str2, long j) {
    ...
    public static String m18359b(String str, String str2, String str3, String str4, int i, @hib String str5, @hib String str6) {
        HashMap map = new HashMap();
    ...
    public static String m18360c(int i, String str, int i2, long j, long j2, boolean z, int i3, String str2, String str3) {
        HashMap map = new HashMap();
    ...
    public static String m18361d(String str, String str2, boolean z) {
        HashMap map = new HashMap();
        map.put("version", str);
        map.put(lz3.f59313l, str2);
        map.put("is_rooted", Boolean.valueOf(z));
        return new JSONObject(map).toString();
    }

    private static String emptyIfNull(@hib String str) {
        return str == null ? "" : str;
    }
}
