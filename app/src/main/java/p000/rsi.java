...
public interface rsi {
    ...
    /* JADX INFO: renamed from: rsi$a */
    public enum EnumC12268a {
        ASCENDING,
        DESCENDING
    }

    EnumC12268a fieldOrder();
    ...
    void writeBytes(int fieldNumber, vj1 value) throws IOException;

    void writeBytesList(int fieldNumber, List<vj1> value) throws IOException;
    ...
    @Deprecated
    void writeGroup(int fieldNumber, Object value, tpe schema) throws IOException;

    @Deprecated
    void writeGroupList(int fieldNumber, List<?> value) throws IOException;

    @Deprecated
    void writeGroupList(int fieldNumber, List<?> value, tpe schema) throws IOException;
    ...
    <K, V> void writeMap(int fieldNumber, os9.C10633b<K, V> metadata, Map<K, V> map) throws IOException;

    void writeMessage(int fieldNumber, Object value) throws IOException;

    void writeMessage(int fieldNumber, Object value, tpe schema) throws IOException;

    void writeMessageList(int fieldNumber, List<?> value) throws IOException;

    void writeMessageList(int fieldNumber, List<?> value, tpe schema) throws IOException;
