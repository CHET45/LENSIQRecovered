...
public final class a5b extends b56 {
    ...
    private final void adjustStorage() {
        if (this.f12704c <= 8 || Long.compareUnsigned(oph.m31533constructorimpl(oph.m31533constructorimpl(this.f12705d) * 32), oph.m31533constructorimpl(oph.m31533constructorimpl(this.f12704c) * 25)) > 0) {
            resizeStorage(coe.nextCapacity(this.f12704c));
        } else {
            resizeStorage(coe.nextCapacity(this.f12704c));
        }
    }
    ...
    private final int findAbsoluteInsertIndex(float f) {
        ...
        while (true) {
            ...
            if ((((~j) << 6) & j & (-9187201950435737472L)) != 0) {
                ...
                if (this.f446e == 0 && ((this.f12702a[iFindFirstAvailableSlot >> 3] >> ((iFindFirstAvailableSlot & 7) << 3)) & 255) != 254) {
                    adjustStorage();
                    iFindFirstAvailableSlot = findFirstAvailableSlot(i2);
                }
                this.f12705d++;
                int i10 = this.f446e;
                long[] jArr2 = this.f12702a;
                int i11 = iFindFirstAvailableSlot >> 3;
                long j5 = jArr2[i11];
                int i12 = (iFindFirstAvailableSlot & 7) << 3;
                this.f446e = i10 - (((j5 >> i12) & 255) == 128 ? 1 : 0);
                jArr2[i11] = (j5 & (~(255 << i12))) | (j2 << i12);
                int i13 = this.f12704c;
    ...
    private final void initializeGrowth() {
        this.f446e = coe.loadedCapacity(getCapacity()) - this.f12705d;
    }
    ...
    private final void resizeStorage(int i) {
        ...
        float[] fArr;
        long[] jArr2 = this.f12702a;
        float[] fArr2 = this.f12703b;
        int i2 = this.f12704c;
        initializeStorage(i);
        float[] fArr3 = this.f12703b;
        int i3 = 0;
        while (i3 < i2) {
    ...
    public final boolean add(float f) {
        int i = this.f12705d;
        this.f12703b[findAbsoluteInsertIndex(f)] = f;
    ...
    */
    public final void minusAssign(float r14) {
        ...
        L6c:
            ...
            goto L13
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.a5b.minusAssign(float):void");
    }
    ...
    */
    public final boolean remove(float r17) {
        ...
        L72:
            ...
            goto L16
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.a5b.remove(float):boolean");
    }
    ...
    public final int trim() {
        int i = this.f12704c;
        int iNormalizeCapacity = coe.normalizeCapacity(coe.unloadedCapacity(this.f12705d));
        if (iNormalizeCapacity >= i) {
            return 0;
        }
        resizeStorage(iNormalizeCapacity);
        return i - this.f12704c;
    }

    public /* synthetic */ a5b(int i, int i2, jt3 jt3Var) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    public final boolean addAll(@yfb b56 b56Var) {
        md8.checkNotNullParameter(b56Var, "elements");
        int i = this.f12705d;
        plusAssign(b56Var);
        return i != this.f12705d;
    }

    public final boolean removeAll(@yfb b56 b56Var) {
        md8.checkNotNullParameter(b56Var, "elements");
        int i = this.f12705d;
        minusAssign(b56Var);
        return i != this.f12705d;
    ...
    public final void plusAssign(@yfb b56 b56Var) {
        md8.checkNotNullParameter(b56Var, "elements");
