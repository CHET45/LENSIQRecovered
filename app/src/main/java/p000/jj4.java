...
public class jj4 {
    ...
    public static final String f50697a = "DocumentFile";

    /* JADX INFO: renamed from: b */
    public static final int f50698b = 512;
    ...
    @hib
    private static String queryForString(Context context, Uri uri, String str, @hib String str2) {
        ContentResolver contentResolver = context.getContentResolver();
        Cursor cursorQuery = null;
        try {
            cursorQuery = contentResolver.query(uri, new String[]{str}, null, null, null);
