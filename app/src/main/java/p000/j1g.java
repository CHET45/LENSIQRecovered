...
public class j1g {
    ...
    public static final Map<String, String> f49365a;

    /* JADX INFO: renamed from: b */
    public static final Map<String, String> f49366b;

    /* JADX INFO: renamed from: c */
    public static final Map<String, String> f49367c;
    ...
    static {
        ...
        f49365a = Collections.unmodifiableMap(map);
        ...
        f49366b = Collections.unmodifiableMap(map2);
        ...
        f49367c = Collections.unmodifiableMap(map3);
    }
    ...
    public static String getCharacteristicName(UUID uuid) {
        ...
        if (standardizedUUIDComponent != null) {
            return f49366b.get(standardizedUUIDComponent);
        }
        return null;
    }
    ...
    public static String getDescriptorName(UUID uuid) {
        String standardizedUUIDComponent = getStandardizedUUIDComponent(uuid);
        if (standardizedUUIDComponent != null) {
            return f49367c.get(standardizedUUIDComponent);
        }
        return null;
    }
    ...
    public static String getServiceName(UUID uuid) {
        String standardizedUUIDComponent = getStandardizedUUIDComponent(uuid);
        if (standardizedUUIDComponent != null) {
            return f49365a.get(standardizedUUIDComponent);
        }
        return null;
    }
