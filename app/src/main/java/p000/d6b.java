...
public final class d6b<K> extends vjb<K> {
    ...
    private final void adjustStorage() {
        if (this.f91400d <= 8 || Long.compareUnsigned(oph.m31533constructorimpl(oph.m31533constructorimpl(this.f91401e) * 32), oph.m31533constructorimpl(oph.m31533constructorimpl(this.f91400d) * 25)) > 0) {
            resizeStorage(coe.nextCapacity(this.f91400d));
        } else {
            resizeStorage(coe.nextCapacity(this.f91400d));
        }
    }
    ...
    private final int findIndex(K k) {
        ...
        while (true) {
            ...
            if ((((~j) << 6) & j & (-9187201950435737472L)) != 0) {
                ...
                if (this.f28554f == 0 && ((this.f91397a[iFindFirstAvailableSlot >> 3] >> ((iFindFirstAvailableSlot & 7) << 3)) & 255) != 254) {
                    adjustStorage();
                    iFindFirstAvailableSlot = findFirstAvailableSlot(i2);
                }
                this.f91401e++;
                int i10 = this.f28554f;
                long[] jArr2 = this.f91397a;
                int i11 = iFindFirstAvailableSlot >> 3;
                long j5 = jArr2[i11];
                int i12 = (iFindFirstAvailableSlot & 7) << 3;
                this.f28554f = i10 - (((j5 >> i12) & 255) == 128 ? 1 : 0);
                jArr2[i11] = (j5 & (~(255 << i12))) | (j2 << i12);
                int i13 = this.f91400d;
    ...
    private final void initializeGrowth() {
        this.f28554f = coe.loadedCapacity(getCapacity()) - this.f91401e;
    }
    ...
    private final void initializeStorage(int i) {
        ...
        this.f91398b = new Object[iMax];
        this.f91399c = new float[iMax];
    }
    ...
    private final void resizeStorage(int i) {
        ...
        int i3 = this.f91400d;
        initializeStorage(i);
        Object[] objArr2 = this.f91398b;
        float[] fArr2 = this.f91399c;
        int i4 = 0;
        while (i4 < i3) {
    ...
    public final void clear() {
        ...
        u70.fill(this.f91398b, (Object) null, 0, this.f91400d);
        initializeGrowth();
    }

    public final float getOrPut(K k, @yfb ny6<Float> ny6Var) {
    ...
    public final void plusAssign(@yfb vjb<K> vjbVar) {
        md8.checkNotNullParameter(vjbVar, ymh.InterfaceC15729h.f102263c);
        putAll(vjbVar);
    }
    ...
    public final void putAll(@yfb vjb<K> vjbVar) {
        md8.checkNotNullParameter(vjbVar, ymh.InterfaceC15729h.f102263c);
    ...
    public final void removeIf(@yfb gz6<? super K, ? super Float, Boolean> gz6Var) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (gz6Var.invoke(this.f91398b[i4], Float.valueOf(this.f91399c[i4])).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
    ...
    public final void set(K k, float f) {
        ...
        this.f91398b[iFindIndex] = k;
        this.f91399c[iFindIndex] = f;
    }

    public final int trim() {
        int i = this.f91400d;
        int iNormalizeCapacity = coe.normalizeCapacity(coe.unloadedCapacity(this.f91401e));
        if (iNormalizeCapacity >= i) {
            return 0;
        }
        resizeStorage(iNormalizeCapacity);
        return i - this.f91400d;
    }

    public /* synthetic */ d6b(int i, int i2, jt3 jt3Var) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    public final boolean remove(K k, float f) {
        int iFindKeyIndex = findKeyIndex(k);
        if (iFindKeyIndex < 0 || this.f91399c[iFindKeyIndex] != f) {
            return false;
        }
        removeValueAt(iFindKeyIndex);
        return true;
