...
public class md8 {
    ...
    public static <T extends Throwable> T m17263a(T t, String str) {
    ...
    public static void checkHasClass(String str) throws ClassNotFoundException {
        String strReplace = str.replace('/', a18.f100c);
        try {
    ...
    private static <T extends Throwable> T sanitizeStackTrace(T t) {
        return (T) m17263a(t, md8.class.getName());
    }
    ...
    public static void throwNpe() {
        throw ((vs8) sanitizeStackTrace(new vs8()));
    }
    ...
    public static void throwUninitializedProperty(String str) {
        throw ((ush) sanitizeStackTrace(new ush(str)));
    }
    ...
    public static void throwNpe(String str) {
        throw ((vs8) sanitizeStackTrace(new vs8(str)));
    }
