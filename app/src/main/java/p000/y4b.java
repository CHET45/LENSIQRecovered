...
public final class y4b extends r46 {
    ...
    private final void adjustStorage() {
        if (this.f77010d <= 8 || Long.compareUnsigned(oph.m31533constructorimpl(oph.m31533constructorimpl(this.f77011e) * 32), oph.m31533constructorimpl(oph.m31533constructorimpl(this.f77010d) * 25)) > 0) {
            resizeStorage(coe.nextCapacity(this.f77010d));
        } else {
            resizeStorage(coe.nextCapacity(this.f77010d));
        }
    }
    ...
    private final int findInsertIndex(float f) {
        ...
        while (true) {
            ...
            if ((((~j) << 6) & j & (-9187201950435737472L)) != 0) {
                ...
                if (this.f100336f == 0 && ((this.f77007a[iFindFirstAvailableSlot >> 3] >> ((iFindFirstAvailableSlot & 7) << 3)) & 255) != 254) {
                    adjustStorage();
                    iFindFirstAvailableSlot = findFirstAvailableSlot(i2);
                }
                this.f77011e++;
                int i10 = this.f100336f;
                long[] jArr2 = this.f77007a;
                int i11 = iFindFirstAvailableSlot >> 3;
                long j5 = jArr2[i11];
                int i12 = (iFindFirstAvailableSlot & 7) << 3;
                this.f100336f = i10 - (((j5 >> i12) & 255) == 128 ? 1 : 0);
                jArr2[i11] = (j5 & (~(255 << i12))) | (j2 << i12);
                int i13 = this.f77010d;
    ...
    private final void initializeGrowth() {
        this.f100336f = coe.loadedCapacity(getCapacity()) - this.f77011e;
    }
    ...
    private final void initializeStorage(int i) {
        ...
        this.f77008b = new float[iMax];
        this.f77009c = new long[iMax];
    }
    ...
    private final void resizeStorage(int i) {
        ...
        float[] fArr;
        long[] jArr2 = this.f77007a;
        float[] fArr2 = this.f77008b;
        long[] jArr3 = this.f77009c;
        int i2 = this.f77010d;
        initializeStorage(i);
        float[] fArr3 = this.f77008b;
        long[] jArr4 = this.f77009c;
        int i3 = 0;
        while (i3 < i2) {
    ...
    public final long getOrPut(float f, @yfb ny6<Long> ny6Var) {
    ...
    public final void plusAssign(@yfb r46 r46Var) {
        md8.checkNotNullParameter(r46Var, ymh.InterfaceC15729h.f102263c);
        putAll(r46Var);
    }
    ...
    public final void putAll(@yfb r46 r46Var) {
        md8.checkNotNullParameter(r46Var, ymh.InterfaceC15729h.f102263c);
        float[] fArr = r46Var.f77008b;
        long[] jArr = r46Var.f77009c;
        long[] jArr2 = r46Var.f77007a;
    ...
    public final void removeIf(@yfb gz6<? super Float, ? super Long, Boolean> gz6Var) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (gz6Var.invoke(Float.valueOf(this.f77008b[i4]), Long.valueOf(this.f77009c[i4])).booleanValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
    ...
    public final void set(float f, long j) {
        ...
        this.f77008b[iFindInsertIndex] = f;
        this.f77009c[iFindInsertIndex] = j;
    }

    public final int trim() {
        int i = this.f77010d;
        int iNormalizeCapacity = coe.normalizeCapacity(coe.unloadedCapacity(this.f77011e));
        if (iNormalizeCapacity >= i) {
            return 0;
        }
        resizeStorage(iNormalizeCapacity);
        return i - this.f77010d;
    }

    public /* synthetic */ y4b(int i, int i2, jt3 jt3Var) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    public final long put(float f, long j, long j2) {
        ...
        if (iFindInsertIndex < 0) {
            ...
            j2 = this.f77009c[iFindInsertIndex];
        }
        this.f77008b[iFindInsertIndex] = f;
        this.f77009c[iFindInsertIndex] = j;
        return j2;
    ...
    public final boolean remove(float f, long j) {
        int iFindKeyIndex = findKeyIndex(f);
        if (iFindKeyIndex < 0 || this.f77009c[iFindKeyIndex] != j) {
            return false;
        }
        removeValueAt(iFindKeyIndex);
        return true;
