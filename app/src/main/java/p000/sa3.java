    ...
    */
    private static final android.view.inputmethod.CursorAnchorInfo.Builder addCharacterBounds(android.view.inputmethod.CursorAnchorInfo.Builder r17, int r18, int r19, p000.nzb r20, p000.hug r21, p000.rud r22) {
        ...
        L8e:
            return r17
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.sa3.addCharacterBounds(android.view.inputmethod.CursorAnchorInfo$Builder, int, int, nzb, hug, rud):android.view.inputmethod.CursorAnchorInfo$Builder");
    }

    @yfb
    @q64(message = "Only exists to support the legacy TextInputService APIs. It is not used by any Compose code. A copy of this function in foundation is used by the legacy BasicTextField.")
    public static final CursorAnchorInfo build(@yfb CursorAnchorInfo.Builder builder, @yfb zsg zsgVar, @yfb nzb nzbVar, @yfb hug hugVar, @yfb Matrix matrix, @yfb rud rudVar, @yfb rud rudVar2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (i >= 33 && z3) {
            na3.setEditorBoundsInfo(builder, rudVar2);
        }
        if (i >= 34 && z4) {
            qa3.addVisibleLineBounds(builder, hugVar, rudVar);
        }
        return builder.build();
    }

    private static final boolean containsInclusive(rud rudVar, float f, float f2) {
