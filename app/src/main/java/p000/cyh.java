...
public final class cyh {
    ...
    public static final int f28061a = 4;

    /* JADX INFO: renamed from: b */
    public static final int f28062b = 0;

    /* JADX INFO: renamed from: c */
    public static final int f28063c = 1;

    /* JADX INFO: renamed from: d */
    public static final int f28064d = 2;

    /* JADX INFO: renamed from: e */
    public static final int f28065e = 3;
    ...
    public static String getRelativePath(Uri uri, Uri uri2) {
        ...
        if (scheme != null ? !(scheme2 == null || !i80.equalsIgnoreCase(scheme, scheme2)) : scheme2 == null) {
    ...
    public static boolean isAbsolute(@hib String str) {
        ...
        while (i4 <= i2) {
            ...
            if (i4 == i6 && sb.charAt(i5) == '.') {
                ...
                if (i4 == i5 + 2 && sb.charAt(i5) == '.' && sb.charAt(i6) == '.') {
                    iLastIndexOf = sb.lastIndexOf(pj4.f71071b, i5 - 2) + 1;
    ...
    public static String resolve(@hib String str, @hib String str2) {
        StringBuilder sb = new StringBuilder();
        if (str == null) {
            str = "";
        }
    ...
    public static Uri resolveToUri(@hib String str, @hib String str2) {
