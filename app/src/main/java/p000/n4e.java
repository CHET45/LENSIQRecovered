...
public class n4e extends hu0 {
    public n4e(znc zncVar) {
        super(zncVar);
    }

    @Override // p000.ut1
    public void request() {
        if (!this.f44873d.shouldRequestSystemAlertWindowPermission()) {
            finish();
            return;
        }
        if (this.f44873d.getTargetSdkVersion() < 23) {
            this.f44873d.f105531k.add(xnc.f98609f);
            this.f44873d.f105527g.remove(xnc.f98609f);
            finish();
            return;
        }
        if (Settings.canDrawOverlays(this.f44873d.f105521a)) {
            finish();
            return;
        }
    ...
    public void requestAgain(List<String> list) {
        this.f44873d.requestSystemAlertWindowPermissionNow(this);
    }
}
