...
public final class cw7 {
    ...
    /* JADX INFO: renamed from: cw7$a */
    public enum EnumC4540a {
        TYPE_JPG("jpg"),
        TYPE_PNG("png"),
        TYPE_GIF("gif"),
        TYPE_TIFF("tiff"),
    ...
    private static Bitmap addBorder(Bitmap bitmap, @y46(from = 1.0d) float f, @g92 int i, boolean z, float f2, boolean z2) {
        return addBorder(bitmap, f, i, z, new float[]{f2, f2, f2, f2, f2, f2, f2, f2}, z2);
    }

    public static Bitmap addCircleBorder(Bitmap bitmap, @y46(from = 1.0d) float f, @g92 int i) {
        return addBorder(bitmap, f, i, true, 0.0f, false);
    }

    public static Bitmap addCornerBorder(Bitmap bitmap, @y46(from = 1.0d) float f, @g92 int i, @y46(from = 0.0d) float f2) {
    ...
    public static Bitmap addTextWatermark(Bitmap bitmap, String str, int i, @g92 int i2, float f, float f2) {
    ...
    public static Drawable bitmap2Drawable(@hib Bitmap bitmap) {
        if (bitmap == null) {
            return null;
        }
        return new BitmapDrawable(C2479l.getApp().getResources(), bitmap);
    }

    public static Bitmap bytes2Bitmap(@hib byte[] bArr) {
    ...
    public static byte[] compressByQuality(Bitmap bitmap, @h78(from = 0, m12174to = 100) int i) {
    ...
    public static Bitmap drawColor(@efb Bitmap bitmap, @g92 int i) {
        if (bitmap != null) {
    ...
    public static Bitmap drawable2Bitmap(@hib Drawable drawable) {
    ...
    public static byte[] drawable2Bytes(@hib Drawable drawable) {
        if (drawable == null) {
            return null;
        }
    ...
    public static Bitmap fastBlur(Bitmap bitmap, @y46(from = 0.0d, fromInclusive = false, m25645to = 1.0d) float f, @y46(from = 0.0d, fromInclusive = false, m25645to = 25.0d) float f2) {
    ...
    public static EnumC4540a getImageType(String str) {
        return getImageType(C2481n.m4258O(str));
    }

    public static int getRotateDegree(String str) {
        try {
            int attributeInt = new ExifInterface(str).getAttributeInt(k95.f52880C, 1);
            if (attributeInt == 3) {
                return 180;
            }
            if (attributeInt != 6) {
    ...
    public static int[] getSize(String str) {
        return getSize(C2481n.m4258O(str));
    }
    ...
    @c5e(17)
    public static Bitmap renderScriptBlur(Bitmap bitmap, @y46(from = 0.0d, fromInclusive = false, m25645to = 25.0d) float f) {
    ...
    public static Bitmap addCircleBorder(Bitmap bitmap, @y46(from = 1.0d) float f, @g92 int i, boolean z) {
        return addBorder(bitmap, f, i, true, 0.0f, z);
    }

    public static Bitmap addCornerBorder(Bitmap bitmap, @y46(from = 1.0d) float f, @g92 int i, float[] fArr) {
    ...
    public static Bitmap addTextWatermark(Bitmap bitmap, String str, float f, @g92 int i, float f2, float f3, boolean z) {
    ...
    public static byte[] bitmap2Bytes(@hib Bitmap bitmap, @efb Bitmap.CompressFormat compressFormat, int i) {
    ...
    public static byte[] compressByQuality(Bitmap bitmap, @h78(from = 0, m12174to = 100) int i, boolean z) {
        if (isEmptyBitmap(bitmap)) {
            return null;
        }
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
    ...
    public static Bitmap fastBlur(Bitmap bitmap, @y46(from = 0.0d, fromInclusive = false, m25645to = 1.0d) float f, @y46(from = 0.0d, fromInclusive = false, m25645to = 25.0d) float f2, boolean z) {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:16:0x001d -> B:37:0x0032). Please report as a decompilation issue!!! */
    public static EnumC4540a getImageType(File file) throws Throwable {
        FileInputStream fileInputStream;
        EnumC4540a imageType;
    ...
    @c5e(17)
    public static Bitmap renderScriptBlur(Bitmap bitmap, @y46(from = 0.0d, fromInclusive = false, m25645to = 25.0d) float f, boolean z) {
        if (!z) {
            bitmap = bitmap.copy(bitmap.getConfig(), true);
        }
        RenderScript renderScriptCreate = null;
        try {
            renderScriptCreate = RenderScript.create(C2479l.getApp());
    ...
    private static Bitmap addBorder(Bitmap bitmap, @y46(from = 1.0d) float f, @g92 int i, boolean z, float[] fArr, boolean z2) {
        if (isEmptyBitmap(bitmap)) {
            return null;
        }
        if (!z2) {
    ...
    public static Bitmap addCornerBorder(Bitmap bitmap, @y46(from = 1.0d) float f, @g92 int i, float[] fArr, boolean z) {
    ...
    public static Bitmap drawColor(@efb Bitmap bitmap, @g92 int i, boolean z) {
        if (bitmap != null) {
            if (isEmptyBitmap(bitmap)) {
                return null;
            }
    ...
    public static Bitmap fastBlur(Bitmap bitmap, @y46(from = 0.0d, fromInclusive = false, m25645to = 1.0d) float f, @y46(from = 0.0d, fromInclusive = false, m25645to = 25.0d) float f2, boolean z, boolean z2) {
        if (isEmptyBitmap(bitmap)) {
            return null;
        }
        int width = bitmap.getWidth();
    ...
    public static Bitmap toRound(Bitmap bitmap, @h78(from = 0) int i, @g92 int i2) {
        return toRound(bitmap, i, i2, false);
    }

    public static Bitmap toRoundCorner(Bitmap bitmap, float f, @y46(from = 0.0d) float f2, @g92 int i) {
        return toRoundCorner(bitmap, f, f2, i, false);
    }

    public static Bitmap addCornerBorder(Bitmap bitmap, @y46(from = 1.0d) float f, @g92 int i, @y46(from = 0.0d) float f2, boolean z) {
    ...
    public static Bitmap toRound(Bitmap bitmap, @h78(from = 0) int i, @g92 int i2, boolean z) {
        if (isEmptyBitmap(bitmap)) {
            return null;
        }
        int width = bitmap.getWidth();
    ...
    public static Bitmap toRoundCorner(Bitmap bitmap, float[] fArr, @y46(from = 0.0d) float f, @g92 int i) {
    ...
    public static boolean save(Bitmap bitmap, String str, Bitmap.CompressFormat compressFormat, int i) {
        return save(bitmap, C2481n.m4258O(str), compressFormat, i, false);
    }
    ...
    public static Bitmap toRoundCorner(Bitmap bitmap, float f, @y46(from = 0.0d) float f2, @g92 int i, boolean z) {
    ...
    public static boolean save(Bitmap bitmap, String str, Bitmap.CompressFormat compressFormat, int i, boolean z) {
        return save(bitmap, C2481n.m4258O(str), compressFormat, i, z);
    }
    ...
    public static Bitmap toRoundCorner(Bitmap bitmap, float[] fArr, @y46(from = 0.0d) float f, @g92 int i, boolean z) {
        if (isEmptyBitmap(bitmap)) {
            return null;
        }
        int width = bitmap.getWidth();
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:29:0x0061 -> B:48:0x0070). Please report as a decompilation issue!!! */
    ...
    */
    public static java.io.File save2Album(android.graphics.Bitmap r6, java.lang.String r7, android.graphics.Bitmap.CompressFormat r8, int r9, boolean r10) throws java.lang.Throwable {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.cw7.save2Album(android.graphics.Bitmap, java.lang.String, android.graphics.Bitmap$CompressFormat, int, boolean):java.io.File");
    }
    ...
    private static EnumC4540a getImageType(InputStream inputStream) {
        if (inputStream == null) {
            return null;
        }
        try {
    ...
    private static EnumC4540a getImageType(byte[] bArr) {
        String upperCase = C2481n.m4309k(bArr).toUpperCase();
        if (upperCase.contains("FFD8FF")) {
            return EnumC4540a.TYPE_JPG;
        }
        if (upperCase.contains("89504E47")) {
            return EnumC4540a.TYPE_PNG;
        }
        if (upperCase.contains("47494638")) {
            return EnumC4540a.TYPE_GIF;
        }
        if (!upperCase.contains("49492A00") && !upperCase.contains("4D4D002A")) {
            if (upperCase.contains("424D")) {
                return EnumC4540a.TYPE_BMP;
            }
            if (upperCase.startsWith("52494646") && upperCase.endsWith("57454250")) {
                return EnumC4540a.TYPE_WEBP;
            }
            if (!upperCase.contains("00000100") && !upperCase.contains("00000200")) {
                return EnumC4540a.TYPE_UNKNOWN;
            }
            return EnumC4540a.TYPE_ICO;
        }
        return EnumC4540a.TYPE_TIFF;
    }
    ...
    public static Bitmap getBitmap(@gq4 int i) {
        Drawable drawable = lx2.getDrawable(C2479l.getApp(), i);
        if (drawable == null) {
            return null;
        }
        Canvas canvas = new Canvas();
    ...
    public static Bitmap getBitmap(@gq4 int i, int i2, int i3) {
        BitmapFactory.Options options = new BitmapFactory.Options();
