...
public final class ua2 {
    ...
    public static final double f87250a = 95.047d;

    /* JADX INFO: renamed from: b */
    public static final double f87251b = 100.0d;

    /* JADX INFO: renamed from: c */
    public static final double f87252c = 108.883d;

    /* JADX INFO: renamed from: d */
    public static final double f87253d = 0.008856d;

    /* JADX INFO: renamed from: e */
    public static final double f87254e = 903.3d;

    /* JADX INFO: renamed from: f */
    public static final int f87255f = 10;

    /* JADX INFO: renamed from: g */
    public static final int f87256g = 1;

    /* JADX INFO: renamed from: h */
    public static final ThreadLocal<double[]> f87257h = new ThreadLocal<>();

    /* JADX INFO: renamed from: ua2$a */
    @c5e(26)
    public static class C13426a {
        private C13426a() {
        }

        @ih4
        /* JADX INFO: renamed from: a */
        public static Color m23169a(Color color, Color color2) {
            if (!Objects.equals(color.getModel(), color2.getModel())) {
                throw new IllegalArgumentException("Color models must match (" + color.getModel() + " vs. " + color2.getModel() + c0b.f15434d);
            }
    ...
    @g92
    public static int HSLToColor(@efb float[] fArr) {
        int iRound;
        int iRound2;
        int iRound3;
        float f = fArr[0];
    ...
    @g92
    public static int LABToColor(@y46(from = 0.0d, m25645to = f87251b) double d, @y46(from = -128.0d, m25645to = 127.0d) double d2, @y46(from = -128.0d, m25645to = 127.0d) double d3) {
        double[] tempDouble3Array = getTempDouble3Array();
        LABToXYZ(d, d2, d3, tempDouble3Array);
        return XYZToColor(tempDouble3Array[0], tempDouble3Array[1], tempDouble3Array[2]);
    }

    public static void LABToXYZ(@y46(from = 0.0d, m25645to = f87251b) double d, @y46(from = -128.0d, m25645to = 127.0d) double d2, @y46(from = -128.0d, m25645to = 127.0d) double d3, @efb double[] dArr) {
    ...
    @g92
    public static int M3HCTToColor(@y46(from = 0.0d, m25645to = 360.0d, toInclusive = false) float f, @y46(from = 0.0d, m25645to = ak4.f1794d, toInclusive = false) float f2, @y46(from = 0.0d, m25645to = f87251b) float f3) {
        return yo1.toColor(f, f2, f3);
    }

    public static void RGBToHSL(@h78(from = 0, m12174to = coe.f17274d) int i, @h78(from = 0, m12174to = coe.f17274d) int i2, @h78(from = 0, m12174to = coe.f17274d) int i3, @efb float[] fArr) {
        float f;
        float fAbs;
        float f2 = i / 255.0f;
        float f3 = i2 / 255.0f;
    ...
    public static void RGBToLAB(@h78(from = 0, m12174to = coe.f17274d) int i, @h78(from = 0, m12174to = coe.f17274d) int i2, @h78(from = 0, m12174to = coe.f17274d) int i3, @efb double[] dArr) {
        RGBToXYZ(i, i2, i3, dArr);
        XYZToLAB(dArr[0], dArr[1], dArr[2], dArr);
    }

    public static void RGBToXYZ(@h78(from = 0, m12174to = coe.f17274d) int i, @h78(from = 0, m12174to = coe.f17274d) int i2, @h78(from = 0, m12174to = coe.f17274d) int i3, @efb double[] dArr) {
        if (dArr.length != 3) {
    ...
    @g92
    public static int XYZToColor(@y46(from = 0.0d, m25645to = f87250a) double d, @y46(from = 0.0d, m25645to = f87251b) double d2, @y46(from = 0.0d, m25645to = f87252c) double d3) {
    ...
    public static void XYZToLAB(@y46(from = 0.0d, m25645to = f87250a) double d, @y46(from = 0.0d, m25645to = f87251b) double d2, @y46(from = 0.0d, m25645to = f87252c) double d3, @efb double[] dArr) {
        if (dArr.length != 3) {
    ...
    @fdi
    /* JADX INFO: renamed from: a */
    public static float m23168a(float f, float f2, float f3) {
    ...
    @g92
    public static int blendARGB(@g92 int i, @g92 int i2, @y46(from = 0.0d, m25645to = 1.0d) float f) {
        float f2 = 1.0f - f;
        return Color.argb((int) ((Color.alpha(i) * f2) + (Color.alpha(i2) * f)), (int) ((Color.red(i) * f2) + (Color.red(i2) * f)), (int) ((Color.green(i) * f2) + (Color.green(i2) * f)), (int) ((Color.blue(i) * f2) + (Color.blue(i2) * f)));
    }

    public static void blendHSL(@efb float[] fArr, @efb float[] fArr2, @y46(from = 0.0d, m25645to = 1.0d) float f, @efb float[] fArr3) {
        if (fArr3.length != 3) {
            throw new IllegalArgumentException("result must have a length of 3.");
        }
        float f2 = 1.0f - f;
        fArr3[0] = m23168a(fArr[0], fArr2[0], f);
        fArr3[1] = (fArr[1] * f2) + (fArr2[1] * f);
        fArr3[2] = (fArr[2] * f2) + (fArr2[2] * f);
    }

    public static void blendLAB(@efb double[] dArr, @efb double[] dArr2, @y46(from = 0.0d, m25645to = 1.0d) double d, @efb double[] dArr3) {
        if (dArr3.length != 3) {
    ...
    public static double calculateContrast(@g92 int i, @g92 int i2) {
    ...
    public static double calculateLuminance(@g92 int i) {
        double[] tempDouble3Array = getTempDouble3Array();
        colorToXYZ(i, tempDouble3Array);
        return tempDouble3Array[1] / 100.0d;
    }

    public static int calculateMinimumAlpha(@g92 int i, @g92 int i2, float f) {
        int i3 = 255;
        if (Color.alpha(i2) != 255) {
            throw new IllegalArgumentException("background can not be translucent: #" + Integer.toHexString(i2));
        }
    ...
    public static void colorToHSL(@g92 int i, @efb float[] fArr) {
        RGBToHSL(Color.red(i), Color.green(i), Color.blue(i), fArr);
    }

    public static void colorToLAB(@g92 int i, @efb double[] dArr) {
        RGBToLAB(Color.red(i), Color.green(i), Color.blue(i), dArr);
    }

    public static void colorToM3HCT(@g92 int i, @efb @zpf(3) float[] fArr) {
        yo1.getM3HCTfromColor(i, fArr);
    }

    public static void colorToXYZ(@g92 int i, @efb double[] dArr) {
    ...
    public static int compositeColors(@g92 int i, @g92 int i2) {
    ...
    public static double distanceEuclidean(@efb double[] dArr, @efb double[] dArr2) {
        return Math.sqrt(Math.pow(dArr[0] - dArr2[0], 2.0d) + Math.pow(dArr[1] - dArr2[1], 2.0d) + Math.pow(dArr[2] - dArr2[2], 2.0d));
    }

    private static double[] getTempDouble3Array() {
        ThreadLocal<double[]> threadLocal = f87257h;
    ...
    @c5e(26)
    @efb
    public static Color compositeColors(@efb Color color, @efb Color color2) {
        return C13426a.m23169a(color, color2);
    }
}
