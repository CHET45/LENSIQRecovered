...
public class pk1 {
    ...
    public static final char[] f71154a = "0123456789ABCDEF".toCharArray();

    /* JADX INFO: renamed from: b */
    public static final String f71155b = "0123456789ABCDEF";

    /* JADX INFO: renamed from: a */
    private static String m19545a(char c) {
    ...
    public static boolean checkHexStr(String str) {
        String upperCase;
        int length;
        if (str == null || (length = (upperCase = str.trim().replace(C2473f.f17566z, "").toUpperCase(Locale.US)).length()) <= 1 || length % 2 != 0) {
            return false;
        }
        int i = 0;
        while (i < length) {
    ...
    public static byte decodeHexChar(char c, char c2) {
        String strM19545a = m19545a(c);
        String strM19545a2 = m19545a(c2);
        if (TextUtils.isEmpty(strM19545a)) {
            strM19545a = "";
        }
        if (!TextUtils.isEmpty(strM19545a2)) {
            strM19545a = strM19545a + strM19545a2;
        }
        if (TextUtils.isEmpty(strM19545a)) {
            return (byte) 0;
        }
        return decodeBinaryString(strM19545a);
    }
    ...
    public static byte[] hexStr2Bytes(String str) {
        ...
        String upperCase = str.trim().replace(C2473f.f17566z, "").toUpperCase(Locale.US);
