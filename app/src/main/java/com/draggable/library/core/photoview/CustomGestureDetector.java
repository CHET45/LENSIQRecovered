...
class CustomGestureDetector {
    ...
    public CustomGestureDetector(Context context, OnGestureListener onGestureListener) {
        ...
        this.mDetector = new ScaleGestureDetector(context, new ScaleGestureDetector.OnScaleGestureListener() { // from class: com.draggable.library.core.photoview.CustomGestureDetector.1
