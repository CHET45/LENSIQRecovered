...
@e0g(parameters = 0)
public class ImageUpScale2Util implements InterfaceC1154n {
    ...
    @gib
    private ImageEnhancer imageUpscaler;
    ...
    public static final class Companion {
        ...
        @yfb
        public final ImageUpScale2Util init(@yfb FragmentActivity fragmentActivity) {
            md8.checkNotNullParameter(fragmentActivity, "activity");
            ImageUpScale2Util imageUpScale2Util = new ImageUpScale2Util(fragmentActivity, null);
            fragmentActivity.getLifecycle().addObserver(imageUpScale2Util);
            return imageUpScale2Util;
        }
    ...
    public /* synthetic */ ImageUpScale2Util(FragmentActivity fragmentActivity, jt3 jt3Var) {
        this(fragmentActivity);
    }

    public static /* synthetic */ void applyImageUpScale$default(ImageUpScale2Util imageUpScale2Util, Bitmap bitmap, boolean z, ImageEnhancer.DenoiseMethod denoiseMethod, boolean z2, qy6 qy6Var, qy6 qy6Var2, int i, Object obj) {
        if (obj != null) {
        ...
        imageUpScale2Util.applyImageUpScale(bitmap, (i & 2) != 0 ? false : z, (i & 4) != 0 ? ImageEnhancer.DenoiseMethod.BILATERAL : denoiseMethod, (i & 8) != 0 ? false : z2, qy6Var, qy6Var2);
    }
    ...
    public final void applyImageUpScale(@yfb Bitmap bitmap, @yfb qy6<? super Float, bth> qy6Var, @yfb qy6<? super ImageUpScaleResult, bth> qy6Var2) {
        ...
        applyImageUpScale$default(this, bitmap, false, null, false, qy6Var, qy6Var2, 14, null);
    }
    ...
    public final void release() {
        ...
        ImageEnhancer imageEnhancer = this.imageUpscaler;
    ...
    private ImageUpScale2Util(FragmentActivity fragmentActivity) {
    ...
    public final void applyImageUpScale(@yfb Bitmap bitmap, boolean z, @yfb qy6<? super Float, bth> qy6Var, @yfb qy6<? super ImageUpScaleResult, bth> qy6Var2) {
        ...
        md8.checkNotNullParameter(qy6Var, "progressCallback");
        md8.checkNotNullParameter(qy6Var2, "block");
        applyImageUpScale$default(this, bitmap, z, null, false, qy6Var, qy6Var2, 12, null);
    }

    @yn8
    public final void applyImageUpScale(@yfb Bitmap bitmap, boolean z, @yfb ImageEnhancer.DenoiseMethod denoiseMethod, @yfb qy6<? super Float, bth> qy6Var, @yfb qy6<? super ImageUpScaleResult, bth> qy6Var2) {
        md8.checkNotNullParameter(bitmap, "originBitmap");
        md8.checkNotNullParameter(denoiseMethod, "denoiseMethod");
        md8.checkNotNullParameter(qy6Var, "progressCallback");
        md8.checkNotNullParameter(qy6Var2, "block");
        applyImageUpScale$default(this, bitmap, z, denoiseMethod, false, qy6Var, qy6Var2, 8, null);
    }

    @yn8
    public void applyImageUpScale(@yfb Bitmap bitmap, boolean z, @yfb ImageEnhancer.DenoiseMethod denoiseMethod, boolean z2, @yfb qy6<? super Float, bth> qy6Var, @yfb qy6<? super ImageUpScaleResult, bth> qy6Var2) {
        md8.checkNotNullParameter(bitmap, "originBitmap");
        md8.checkNotNullParameter(denoiseMethod, "denoiseMethod");
        md8.checkNotNullParameter(qy6Var, "progressCallback");
        md8.checkNotNullParameter(qy6Var2, "block");
        ...
        if (mActivity != null) {
            if (this.imageUpscaler == null) {
                ImageEnhancer imageEnhancer = new ImageEnhancer(mActivity);
                this.imageUpscaler = imageEnhancer;
                md8.checkNotNull(imageEnhancer);
                if (!imageEnhancer.initializeBlocking()) {
                    qy6Var2.invoke(new ImageUpScaleResult(-1, "image upscale sdk init fail", null, 0L, 12, null));
                    this.imageUpscaler = null;
                    return;
                }
            }
            try {
                this.mJob = fg1.launch$default(h59.getLifecycleScope(mActivity), null, null, new ImageUpScale2Util$applyImageUpScale$1$1(this, bitmap, z, denoiseMethod, z2, qy6Var2, qy6Var, null), 3, null);
                return;
            } catch (Exception e) {
                e.printStackTrace();
