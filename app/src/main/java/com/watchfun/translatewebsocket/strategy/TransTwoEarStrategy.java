...
public class TransTwoEarStrategy implements WebSocketManagerStrategy {
    private final TransTwoEarWebSocketManager manager = TransTwoEarWebSocketManager.getInstance();
