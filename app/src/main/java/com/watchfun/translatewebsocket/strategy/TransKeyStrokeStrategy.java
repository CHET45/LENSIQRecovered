...
public class TransKeyStrokeStrategy implements WebSocketManagerStrategy {
    private final KetStrokeTransWebSocketManager manager = KetStrokeTransWebSocketManager.getInstance();
