...
public class TransFreedomStrategy implements WebSocketManagerStrategy {
    private final FreedomTransWebSocketManager manager = FreedomTransWebSocketManager.getInstance();
