...
public class TransMachineStrategy implements WebSocketManagerStrategy {
    private final TransMachineWebSocketManager manager = TransMachineWebSocketManager.getInstance();
