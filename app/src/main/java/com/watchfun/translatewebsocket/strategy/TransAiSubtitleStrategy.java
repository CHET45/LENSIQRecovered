...
import com.watchfun.translatewebsocket.AiSubtitlesWebSocketManager;
import com.watchfun.translatewebsocket.BaseNewWebSocketManager;
import java.util.Map;

/* JADX INFO: loaded from: classes7.dex */
public class TransAiSubtitleStrategy implements WebSocketManagerStrategy {
    private final AiSubtitlesWebSocketManager manager = AiSubtitlesWebSocketManager.getInstance();
