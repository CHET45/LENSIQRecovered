...
public class TransCallRealStrategy implements WebSocketManagerStrategy {
    private final VideoCallRealWebSocketManager manager = VideoCallRealWebSocketManager.getInstance();
