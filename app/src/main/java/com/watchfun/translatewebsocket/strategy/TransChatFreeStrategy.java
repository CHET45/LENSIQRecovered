...
public class TransChatFreeStrategy implements WebSocketManagerStrategy {
    private final TransChatFreeWebSocketManager manager = TransChatFreeWebSocketManager.getInstance();
