...
import com.watchfun.translatewebsocket.FreedomTransWebSocketManager;
...
public class FreedomTransWebSocketManager extends BaseNewWebSocketManager {

    @igg({"StaticFieldLeak"})
    private static volatile FreedomTransWebSocketManager mTranslateSocketManager;
    private boolean isSendFileToPlay;
    private OnTtsMp3Listener onTtsMp3Listener;
    private long startTime;
    private int transMode;
    private final String TAG = "FreedomTransWebSocketManager";
    ...
    public FreedomTransWebSocketManager() {
        AudioNewRecorder.getInstance().createDefaultAudio();
    }

    public static FreedomTransWebSocketManager getInstance() {
        if (mTranslateSocketManager == null) {
            synchronized (FreedomTransWebSocketManager.class) {
                try {
                    if (mTranslateSocketManager == null) {
                        mTranslateSocketManager = new FreedomTransWebSocketManager();
                    }
                } finally {
                }
            }
    ...
    public /* synthetic */ void lambda$onAudioEnd$0(String str, int i) {
        ...
        C2473f.m4173i("FreedomTransWebSocketManager", str + ":::mp3地址:::" + str2);
        try {
    ...
    public /* synthetic */ void lambda$release$2() {
        xt5.deleteFilesInDirWithFilter(new File(getOutputPath()), new FileFilter() { // from class: hx6
            @Override // java.io.FileFilter
            public final boolean accept(File file) {
                return FreedomTransWebSocketManager.lambda$release$1(file);
            }
        });
    }
    ...
    public void init() {
        C2473f.m4167d("aaaaaaaa", "setTransMode--------------------------" + this.transMode);
    ...
    public void onAudioEnd(String str, int i, String str2, final int i2) {
        ...
        if (str2.contains(st5.f82815c) && !this.isAsring) {
            ...
            C2478k.getSinglePool().execute(new Runnable() { // from class: ix6
                @Override // java.lang.Runnable
                public final void run() {
                    this.f48769a.lambda$onAudioEnd$0(str3, i2);
                }
            });
            ...
            C2473f.m4168e("FreedomTransWebSocketManager", "onAudioEnd最后回调音频数据:" + this.ttsFilepath);
    ...
    public void onMessage(byte[] bArr, String str, String str2, String str3, String str4, int i) throws Throwable {
        ...
        C2473f.m4168e("FreedomTransWebSocketManager", "messageId=" + str2);
        if (str3.contains(st5.f82815c)) {
            ...
            if (this.asrDataListener != null && this.curStartTimeId.equals(str)) {
                ...
                if (byteArray.length > 0 && !this.isAsring) {
                    Log.e("FreedomTransWebSocketManager", "发送pcm数据:" + byteArray.length);
            ...
            if (this.asrDataListener != null && this.curStartTimeId.equals(str) && xt5.isFileExists(str5) && !this.isSendFileToPlay && !this.isAsring && bArrMerge.length > 5000) {
                C2473f.m4173i("FreedomTransWebSocketManager", "最后播放音频:" + str5);
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("ttsFilepath=");
        sb.append(this.ttsFilepath);
        C2473f.m4168e("FreedomTransWebSocketManager", sb.toString());
    }
    ...
    public void release() {
        ...
        if (!TextUtils.isEmpty(getOutputPath())) {
            C2478k.getCachedPool().execute(new Runnable() { // from class: jx6
                @Override // java.lang.Runnable
                public final void run() {
                    this.f52174a.lambda$release$2();
                }
            });
        }
        resetProvider();
    ...
    public void startWssRecord(String str) {
        if (TextUtils.isEmpty(str)) {
            AudioNewRecorder.getInstance().startRecord(new AudioNewRecorder.RecordStreamListener() { // from class: gx6
                ...
                public final void recordOfByte(byte[] bArr, int i, int i2) {
                    this.f41759a.lambda$startWssRecord$4(bArr, i, i2);
                }
            });
        } else {
            AudioNewRecorder.getInstance().startRecord(str, new AudioNewRecorder.RecordStreamListener() { // from class: fx6
                @Override // com.watchfun.translatewebsocket.AudioNewRecorder.RecordStreamListener
                public final void recordOfByte(byte[] bArr, int i, int i2) {
                    this.f37940a.lambda$startWssRecord$3(bArr, i, i2);
                }
            });
        }
    }
