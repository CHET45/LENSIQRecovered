package com.watchfun.translatewebsocket.databinding;
...
import com.watchfun.translatewebsocket.C4250R;
import p000.efb;
import p000.hib;
import p000.j8i;
...
public final class ActivityMainBinding implements j8i {
    ...
    public static ActivityMainBinding bind(@efb View view) {
        int i = C4250R.id.tv_result;
        TextView textView = (TextView) view.findViewById(i);
        if (textView != null) {
            i = C4250R.id.tv_start;
    ...
    public static ActivityMainBinding inflate(@efb LayoutInflater layoutInflater, @hib ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C4250R.layout.activity_main, viewGroup, false);
        if (z) {
