...
public class DataBinderMapperImpl extends jf3 {
    ...
    public static final SparseIntArray f24997a = new SparseIntArray(0);

    /* JADX INFO: renamed from: com.watchfun.aichat.DataBinderMapperImpl$a */
    public static class C3991a {

        /* JADX INFO: renamed from: a */
        public static final SparseArray<String> f24998a;
    ...
    /* JADX INFO: renamed from: com.watchfun.aichat.DataBinderMapperImpl$b */
    public static class C3992b {

        /* JADX INFO: renamed from: a */
        public static final HashMap<String, Integer> f24999a = new HashMap<>(0);
    ...
    public int getLayoutId(String str) {
        Integer num;
        if (str == null || (num = C3992b.f24999a.get(str)) == null) {
            return 0;
        }
        return num.intValue();
    }
    ...
    public y8i getDataBinder(DataBindingComponent dataBindingComponent, View[] viewArr, int i) {
        if (viewArr == null || viewArr.length == 0 || f24997a.get(i) <= 0 || viewArr[0].getTag() != null) {
            return null;
        }
        throw new RuntimeException("view must have a tag");
    }
